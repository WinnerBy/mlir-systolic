...
void A_IO_L2_in_intra_trans(int idx, int c0, int c2, int c3, A_t16 local_A[2][64][8], hls::stream<A_t16> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L2_in_inter_trans(int idx, int c0, int c2, int c3, A_t16 local_A[2][64][8], hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, bool inter_trans_en);
void A_IO_L2_in_inter_trans_boundary(int idx, int c0, int c2, int c3, A_t16 local_A[2][64][8], hls::stream<A_t16> &fifo_A_in, bool inter_trans_en);
void B_IO_L2_in_intra_trans(int idx, int c0, int c2, int c3, B_t16 local_B[64][1], hls::stream<float> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L2_in_inter_trans(int idx, int c0, int c2, int c3, B_t16 local_B[64][1], hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_out, bool inter_trans_en);
void B_IO_L2_in_inter_trans_boundary(int idx, int c0, int c2, int c3, B_t16 local_B[64][1], hls::stream<B_t16> &fifo_B_in, bool inter_trans_en);
void C_IO_L2_in_intra_trans(int idx, int c0, int c2, C_t16 local_C[32][8], hls::stream<C_t16> &fifo_C_local_out, bool intra_trans_en);
void C_IO_L2_in_inter_trans(int idx, int c0, int c2, C_t16 local_C[32][8], hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
void C_IO_L2_in_inter_trans_boundary(int idx, int c0, int c2, C_t16 local_C[32][8], hls::stream<C_t16> &fifo_C_in, bool inter_trans_en);
void PE_wrapper(int idx, int idy, hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, hls::stream<float> &fifo_B_in, hls::stream<float> &fifo_B_out, hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, hls::stream<float> &fifo_D_drain_out);
void D_drain_IO_L1_out_intra_trans(int idx, int idy, int c0, int c2, D_t4 local_D[2][16][8], hls::stream<float> &fifo_D_drain_local_in);
void D_drain_IO_L1_out_inter_trans(int idx, int idy, int c0, int c2, D_t4 local_D[2][16][8], hls::stream<D_t4> &fifo_D_drain_in, hls::stream<D_t4> &fifo_D_drain_out);
void D_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, int c0, int c2, D_t4 local_D[2][16][8], hls::stream<D_t4> &fifo_D_drain_out);
              ...
              #pragma HLS PIPELINE II=1
                {
                  A_t16 in_data;
                  A_t16 out_data;
                  in_data = A[32768*c0 + 512*c3 + 2048*c4 + 1024*c5 + 8*c6 + c7];
                  out_data = in_data;
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, hls::stream<float> &fifo_B_in, hls::stream<float> &fifo_B_out, hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, hls::stream<float> &fifo_D_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t1 local_A[1][1][16];
  #pragma HLS ARRAY_PARTITION variable=local_A dim=3 factor=16 cyclic
  #pragma HLS RESOURCE variable=local_A core=RAM_2P_BRAM
  B_t1 local_B[1][1];
  #pragma HLS ARRAY_PARTITION variable=local_B dim=0 complete
  C_t1 local_C[1][16];
  #pragma HLS ARRAY_PARTITION variable=local_C dim=2 factor=16 cyclic
  #pragma HLS RESOURCE variable=local_C core=RAM_2P_BRAM
  D_t1 local_D[2][16][32];
                  ...
                  #pragma HLS PIPELINE II=1
                    {
                      ...
                      // simd
                      for (ap_uint<5> c12 = 0; c12 <= 15; c12 += 1) {
                      #pragma HLS UNROLL
                        local_D[c11][c10][16*c6 + c9] = (local_D[c11][c10][16*c6 + c9] + ((local_A[0][0][c12] * local_B[0][0]) * local_C[0][c12]));
                      }
                      if (c3 == 1 && c7 == 63 && c8 == 7)
                        fifo_D_drain_out.write(local_D[c11][c10][16*c6 + c9]);
                      {
                        C_t16 fifo_data;
                      ...
                      fifo_B_out.write(local_B[0][0]);
                      {
                        A_t16 fifo_data;
                        union {unsigned int ui; float ut;} u15, u14, u13, u12, u11, u10, u9, u8, u7, u6, u5, u4, u3, u2, u1, u0;
                        u15.ut = local_A[0][0][15];
                        u14.ut = local_A[0][0][14];
                        u13.ut = local_A[0][0][13];
                        u12.ut = local_A[0][0][12];
                        u11.ut = local_A[0][0][11];
                        u10.ut = local_A[0][0][10];
                        u9.ut = local_A[0][0][9];
                        u8.ut = local_A[0][0][8];
                        u7.ut = local_A[0][0][7];
                        u6.ut = local_A[0][0][6];
...
/* Module Definition */
void C_PE_dummy_in(int idx, int idy, hls::stream<C_t16> &fifo_C_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
      ...
      for (ap_uint<5> c10 = 0; c10 <= 15; c10 += 1) {
        ...
        #pragma HLS PIPELINE II=1
          // simd
          {
            ...
            out_data = local_D[c11][c10][(16 * c6 + c9) / 4];
            ...
            out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);            local_D[c11][c10][(16 * c6 + c9) / 4] = out_data;
          }
        }
      }
    }
...
/* Module Definition */
void D_drain_IO_L3_out(D_t16 *D, hls::stream<D_t4> &fifo_D_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  D_t4 data_split[4];
  #pragma HLS ARRAY_PARTITION variable=data_split complete
              ...
              #pragma HLS PIPELINE II=1
                {
                  ...
                  D_t16 out_data;
                  in_data = fifo_D_drain_local_in.read();
                  int split_idx = (131072*c0 + 8*c2 + 512*c4 + 8192*c5 + 4096*c6 + 32*c7 + c8) % 4;
                  data_split[split_idx] = in_data;
                  out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);                  if (c8 % 4 == 4 - 1 || c8 == 7) {
                    D[(((32 * c0 + 2 * c5 + c6) * 128 + (16 * c4 + c7)) * 128 + (32 * c2 + 4 * c8)) / 16] = out_data;
                  }
                }
              }
            }
