...
void A_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, A_t16 local_A[8][2], hls::stream<float> &fifo_A_local_out, bool intra_trans_en);
...
void B_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, B_t16 local_B[8][2], hls::stream<float> &fifo_B_local_out, bool intra_trans_en);
