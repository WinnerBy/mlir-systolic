...
void A_IO_L1_in_intra_trans(int idx, int idy, int c2, A_t2 local_A[16][1], hls::stream<A_t2> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L1_in_inter_trans(int idx, int idy, int c2, A_t2 local_A[16][1], hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, bool inter_trans_en);
void A_IO_L1_in_inter_trans_boundary(int idx, int idy, int c2, A_t2 local_A[16][1], hls::stream<A_t2> &fifo_A_in, bool inter_trans_en);
...
void B_IO_L2_in_intra_trans(int idx, int c2, B_t2 local_B[32][1], hls::stream<B_t2> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L2_in_inter_trans(int idx, int c2, B_t2 local_B[32][1], hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, bool inter_trans_en);
void B_IO_L2_in_inter_trans_boundary(int idx, int c2, B_t2 local_B[32][1], hls::stream<B_t2> &fifo_B_in, bool inter_trans_en);
...
void C_IO_L2_out_intra_trans(int idx, C_t16 local_C[16][2], hls::stream<float> &fifo_C_local_in, bool intra_trans_en);
void C_IO_L2_out_inter_trans(int idx, C_t16 local_C[16][2], hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
void C_IO_L2_out_inter_trans_boundary(int idx, C_t16 local_C[16][2], hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
