...
void A_IO_L1_in_intra_trans(int idx, int c2, A_t2 local_A[32][1], hls::stream<A_t2> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L1_in_inter_trans(int idx, int c2, A_t2 local_A[32][1], hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, bool inter_trans_en);
void A_IO_L1_in_inter_trans_boundary(int idx, int c2, A_t2 local_A[32][1], hls::stream<A_t2> &fifo_A_in, bool inter_trans_en);
...
void B_IO_L1_in_intra_trans(int idx, int c2, B_t2 local_B[32][1], hls::stream<B_t2> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L1_in_inter_trans(int idx, int c2, B_t2 local_B[32][1], hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, bool inter_trans_en);
void B_IO_L1_in_inter_trans_boundary(int idx, int c2, B_t2 local_B[32][1], hls::stream<B_t2> &fifo_B_in, bool inter_trans_en);
...
void C_IO_L2_out_intra_trans(C_t16 local_C[32][2], hls::stream<float> &fifo_C_local_in, bool intra_trans_en);
void C_IO_L2_out_inter_trans_boundary(C_t16 local_C[32][2], hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
        ...
        for (ap_uint<2> c6 = 0; c6 <= 1; c6 += 1) {
          ...
          #pragma HLS PIPELINE II=1
            // simd
            {
              ...
              int split_idx = (2*c5 + c6) % 16;
              out_data = local_C[2*c4 + c7][(2 * c5 + c6) / 16];
              ...
              /* Local Reduction */
              out_data = (data_split[15], data_split[14], data_split[13], data_split[12], data_split[11], data_split[10], data_split[9], data_split[8], data_split[7], data_split[6], data_split[5], data_split[4], data_split[3], data_split[2], data_split[1], data_split[0]);              local_C[2*c4 + c7][(2 * c5 + c6) / 16] = out_data;
            }
          }
        }
      }
