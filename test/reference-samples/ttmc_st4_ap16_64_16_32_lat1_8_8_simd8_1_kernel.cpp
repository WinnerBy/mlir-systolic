...
void A_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, int c3, A_t16 local_A[1][32][8], hls::stream<A_t8> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, int c3, A_t16 local_A[1][32][8], hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, bool inter_trans_en);
void A_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, int c3, A_t16 local_A[1][32][8], hls::stream<A_t16> &fifo_A_in, bool inter_trans_en);
void B_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, int c3, B_t8 local_B[32][1], hls::stream<float> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, int c3, B_t8 local_B[32][1], hls::stream<B_t8> &fifo_B_in, hls::stream<B_t8> &fifo_B_out, bool inter_trans_en);
void B_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, int c3, B_t8 local_B[32][1], hls::stream<B_t8> &fifo_B_in, bool inter_trans_en);
void C_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, C_t16 local_C[16][8], hls::stream<C_t8> &fifo_C_local_out, bool intra_trans_en);
...
void D_drain_IO_L1_out_intra_trans(int idx, int idy, int c0, int c1, int c2, D_t4 local_D[1][8][4], hls::stream<float> &fifo_D_drain_local_in);
void D_drain_IO_L1_out_inter_trans(int idx, int idy, int c0, int c1, int c2, D_t4 local_D[1][8][4], hls::stream<D_t4> &fifo_D_drain_in, hls::stream<D_t4> &fifo_D_drain_out);
void D_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, int c0, int c1, int c2, D_t4 local_D[1][8][4], hls::stream<D_t4> &fifo_D_drain_out);
          ...
          for (ap_uint<4> c9 = 0; c9 <= 7; c9 += 1) {
            ...
            #pragma HLS PIPELINE II=1
              // simd
              {
                C_t16 in_data;
                C_t8 out_data;
                in_data = local_C[8*c6 + c9][8 * c8 / 16];
                for (ap_uint<2> n = 0; n < 2; n++) {
                #pragma HLS UNROLL
                  data_split[n] = in_data(255, 0);
                  in_data = in_data >> 256;
                  ...
                  #pragma HLS PIPELINE II=1
                    {
                      ...
                      #pragma HLS UNROLL
                        local_D[0][c10][8*c6 + c9] = (local_D[0][c10][8*c6 + c9] + ((local_A[0][0][c11] * local_B[0][0]) * local_C[0][c11]));
                      }
                      if (c3 == 3 && c7 == 31 && c8 == 15)
                        fifo_D_drain_out.write(local_D[0][c10][8*c6 + c9]);
                      {
                        C_t8 fifo_data;
    ...
    for (ap_uint<4> c9 = 0; c9 <= 7; c9 += 1) {
      ...
      #pragma HLS PIPELINE II=1
        // simd
        {
          ...
          out_data = local_D[0][c10][(8 * c6 + c9) / 4];
          ...
          out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);          local_D[0][c10][(8 * c6 + c9) / 4] = out_data;
        }
      }
    }
  }
...
#pragma HLS DATAFLOW
  ...
  /* PE fifo */ hls::stream<A_t8> fifo_A_PE_13_8;
  ...
  /* PE fifo */ hls::stream<A_t8> fifo_A_PE_14_8;
  ...
  /* PE fifo */ hls::stream<A_t8> fifo_A_PE_15_8;
