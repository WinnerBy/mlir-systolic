...
void A_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, A_t2 local_A[32][1], hls::stream<A_t2> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, A_t2 local_A[32][1], hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, bool inter_trans_en);
void A_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, A_t2 local_A[32][1], hls::stream<A_t2> &fifo_A_in, bool inter_trans_en);
void B_IO_L1_in_intra_trans(int idx, int idy, int c0, int c1, int c2, B_t2 local_B[16][1], hls::stream<B_t2> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L1_in_inter_trans(int idx, int idy, int c0, int c1, int c2, B_t2 local_B[16][1], hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, bool inter_trans_en);
void B_IO_L1_in_inter_trans_boundary(int idx, int idy, int c0, int c1, int c2, B_t2 local_B[16][1], hls::stream<B_t2> &fifo_B_in, bool inter_trans_en);
        ...
        for (ap_uint<2> c3 = 0; c3 <= 1; c3 += 1) {
          ...
          #pragma HLS PIPELINE II=1
            // access_coalesce
            {
              A_t2 in_data;
              A_t2 out_data;
              in_data = A[1024*c0 + 2*c2 + c3 + 32*c4];
              out_data = in_data;
          ...
          for (ap_uint<2> c4 = 0; c4 <= 1; c4 += 1) {
            ...
            #pragma HLS PIPELINE II=1
              // access_coalesce
              {
                B_t2 in_data;
                B_t2 out_data;
                in_data = B[1024*c1 + 2*c2 + c3 + 512*c4 + 32*c5];
                out_data = in_data;
      ...
      for (ap_uint<2> c3 = 0; c3 <= 1; c3 += 1) {
        ...
        #pragma HLS PIPELINE II=1
          // access_coalesce
          {
            ...
            in_data = fifo_C_local_in.read();
            out_data = in_data;
            C[128*c0 + 2*c1 + c3 + 4*c4] = out_data;
          }
        }
      }
    }
