...
extern "C" {
void kernel0(A_t16 *A, B_t4 *B, C_t16 *C, D_t4 *D);
}
              ...
              #pragma HLS PIPELINE II=1
                {
                  A_t16 in_data;
                  A_t16 out_data;
                  in_data = A[262144*c0 + 32*c2 + 32768*c3 + 4096*c4 + 16*c5 + c6];
                  out_data = in_data;
        ...
        for (int c3 = 0; c3 <= min(15, -16 * c1 + 83); c3 += 1) {
          ...
          #pragma HLS PIPELINE II=1
            // access_coalesce
            {
              B_t4 in_data;
              B_t4 out_data;
              in_data = B[16*c1 + 168*c2 + c3 + 84*c4];
              out_data = in_data;
          ...
          #pragma HLS PIPELINE II=1
            {
              C_t16 in_data;
              C_t16 out_data;
              in_data = C[1024*c1 + 64*c3 + 16*c4 + c5];
              out_data = in_data;
...
/* Module Definition */
void D_drain_IO_L3_out(D_t4 *D, hls::stream<D_t4> &fifo_D_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
        ...
        for (ap_uint<4> c4 = 0; c4 <= 7; c4 += 1) {
          ...
          #pragma HLS PIPELINE II=1
            // access_coalesce
            {
              ...
              in_data = fifo_D_drain_local_in.read();
              out_data = in_data;
              D[5376*c0 + 16*c1 + c3 + 672*c4 + 84*c5] = out_data;
            }
          }
        }
      }
