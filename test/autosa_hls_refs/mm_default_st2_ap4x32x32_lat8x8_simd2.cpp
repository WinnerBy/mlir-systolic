...
void A_IO_L1_in_intra_trans(int idx, int c0, int c1, int c2, A_t2 local_A[32][1], hls::stream<A_t2> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L1_in_inter_trans(int idx, int c0, int c1, int c2, A_t2 local_A[32][1], hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, bool inter_trans_en);
void A_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c2, A_t2 local_A[32][1], hls::stream<A_t2> &fifo_A_in, bool inter_trans_en);
...
void B_IO_L1_in_intra_trans(int idx, int c0, int c1, int c2, B_t2 local_B[32][1], hls::stream<B_t2> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L1_in_inter_trans(int idx, int c0, int c1, int c2, B_t2 local_B[32][1], hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, bool inter_trans_en);
void B_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c2, B_t2 local_B[32][1], hls::stream<B_t2> &fifo_B_in, bool inter_trans_en);
...
void C_IO_L2_out_intra_trans(int c0, int c1, C_t16 *C, C_t16 local_C[32][2], hls::stream<float> &fifo_C_local_in, bool intra_trans_en);
void C_IO_L2_out_inter_trans_boundary(int c0, int c1, C_t16 *C, C_t16 local_C[32][2], hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);

/* Module Definition */
void A_IO_L2_in(A_t2 *A, hls::stream<A_t2> &fifo_A_local_out) {
    ...
    #pragma HLS PIPELINE II=1
      {
        ...
        out_data = in_data;
        C[128*c0 + 2*c1 + 4*c3 + c4] = out_data;
      }
    }
  }
}
...
/* Module Definition */
void C_IO_L2_out_boundary(C_t16 *C, hls::stream<float> &fifo_C_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
