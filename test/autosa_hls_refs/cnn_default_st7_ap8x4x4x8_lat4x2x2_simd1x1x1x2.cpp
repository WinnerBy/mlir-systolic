...
void cin_IO_L1_in_intra_trans(int idx, int idy, int c0, int c1, int c2, int c3, cin_t4 local_cin[4][4][2], hls::stream<cin_t2> &fifo_cin_local_out, bool intra_trans_en);
void cin_IO_L1_in_inter_trans(int idx, int idy, int c0, int c1, int c2, int c3, cin_t4 local_cin[4][4][2], hls::stream<cin_t4> &fifo_cin_in, hls::stream<cin_t4> &fifo_cin_out, bool inter_trans_en);
void cin_IO_L1_in_inter_trans_boundary(int idx, int idy, int c0, int c1, int c2, int c3, cin_t4 local_cin[4][4][2], hls::stream<cin_t4> &fifo_cin_in, bool inter_trans_en);
void cin_IO_L1_in_wrapper(int idx, int idy, hls::stream<cin_t4> &fifo_cin_in, hls::stream<cin_t4> &fifo_cin_out, hls::stream<cin_t2> &fifo_cin_local_out);
void cin_IO_L1_in_boundary_wrapper(int idx, int idy, hls::stream<cin_t4> &fifo_cin_in, hls::stream<cin_t2> &fifo_cin_local_out);
void w_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, int c3, w_t8 local_w[4][3][3][1], hls::stream<w_t2> &fifo_w_local_out, bool intra_trans_en);
void w_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, int c3, w_t8 local_w[4][3][3][1], hls::stream<w_t8> &fifo_w_in, hls::stream<w_t8> &fifo_w_out, bool inter_trans_en);
void w_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, int c3, w_t8 local_w[4][3][3][1], hls::stream<w_t8> &fifo_w_in, bool inter_trans_en);
void PE_wrapper(int idx, int idy, hls::stream<cin_t2> &fifo_cin_in, hls::stream<float> &fifo_cout_drain_out, hls::stream<w_t2> &fifo_w_in, hls::stream<w_t2> &fifo_w_out);
void cout_drain_IO_L1_out_intra_trans(int idx, int idy, int c0, int c1, int c2, cout_t4 local_cout[2][2][1], hls::stream<float> &fifo_cout_drain_local_in);
void cout_drain_IO_L1_out_inter_trans(int idx, int idy, int c0, int c1, int c2, cout_t4 local_cout[2][2][1], hls::stream<cout_t4> &fifo_cout_drain_in, hls::stream<cout_t4> &fifo_cout_drain_out);
void cout_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, int c0, int c1, int c2, cout_t4 local_cout[2][2][1], hls::stream<cout_t4> &fifo_cout_drain_out);
...
/* Module Definition */
void cin_IO_L3_in(hls::stream<cin_t4> &fifo_cin_in, hls::stream<cin_t4> &fifo_cin_local_out) {
...
/* Module Definition */
void cin_IO_L3_in_serialize(cin_t16 *cin, hls::stream<cin_t4> &fifo_cin_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void cin_IO_L2_in(int idx, hls::stream<cin_t4> &fifo_cin_in, hls::stream<cin_t4> &fifo_cin_out, hls::stream<cin_t4> &fifo_cin_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
...
/* Module Definition */
void cin_IO_L2_in_boundary(int idx, hls::stream<cin_t4> &fifo_cin_in, hls::stream<cin_t4> &fifo_cin_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
          ...
          for (ap_uint<2> c11 = 0; c11 <= 1; c11 += 1) {
            ...
            #pragma HLS PIPELINE II=1
              // simd
              {
                cin_t4 in_data;
                cin_t2 out_data;
                in_data = local_cin[c10 + c8][c11 + c9][2 * c7 / 4];
...
/* Module Definition */
void cin_IO_L1_in(int idx, int idy, hls::stream<cin_t4> &fifo_cin_in, hls::stream<cin_t4> &fifo_cin_out, hls::stream<cin_t2> &fifo_cin_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  cin_t4 local_cin_ping[4][4][2];
  #pragma HLS RESOURCE variable=local_cin_ping core=RAM_2P_BRAM
  cin_t4 local_cin_pong[4][4][2];
...
/* Module Definition */
void cin_IO_L1_in_boundary(int idx, int idy, hls::stream<cin_t4> &fifo_cin_in, hls::stream<cin_t2> &fifo_cin_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  cin_t4 local_cin_ping[4][4][2];
          ...
          for (ap_uint<2> c11 = 0; c11 <= 1; c11 += 1) {
            ...
            #pragma HLS PIPELINE II=1
              // simd
              {
                w_t8 in_data;
                w_t2 out_data;
                in_data = local_w[c12][c8][c9][2 * c7 / 8];
...
/* Module Definition */
void w_IO_L2_in(int idx, hls::stream<w_t8> &fifo_w_in, hls::stream<w_t8> &fifo_w_out, hls::stream<w_t2> &fifo_w_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
...
/* Module Definition */
void w_IO_L2_in_boundary(int idx, hls::stream<w_t8> &fifo_w_in, hls::stream<w_t2> &fifo_w_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  w_t8 local_w_ping[4][3][3][1];
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<cin_t2> &fifo_cin_in, hls::stream<float> &fifo_cout_drain_out, hls::stream<w_t2> &fifo_w_in, hls::stream<w_t2> &fifo_w_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  cin_t1 local_cin[1][1][2];
  #pragma HLS ARRAY_PARTITION variable=local_cin dim=0 complete
  cout_t1 local_cout[2][2][4];
  #pragma HLS RESOURCE variable=local_cout core=RAM_2P_BRAM
  w_t1 local_w[1][1][1][2];
                    ...
                    #pragma HLS PIPELINE II=1
                      {
                        ...
                        // simd
                        for (ap_uint<2> c13 = 0; c13 <= 1; c13 += 1) {
                        #pragma HLS UNROLL
                          local_cout[c10][c11][c12] = (local_cout[c10][c11][c12] + (local_cin[0][0][c13] * local_w[0][0][0][c13]));
                        }
                        {
                          w_t2 fifo_data;
                        ...
                        if (c3 == 1 && c7 == 3 && c8 == 2 && c9 == 2)
                          fifo_cout_drain_out.write(local_cout[c10][c11][c12]);
                      }
                    }
                  }
                }
...
/* Module Definition */
void w_PE_dummy_in(int idx, int idy, hls::stream<w_t2> &fifo_w_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
    ...
    for (ap_uint<2> c11 = 0; c11 <= 1; c11 += 1) {
      ...
      #pragma HLS PIPELINE II=1
        // simd
        {
          ...
          int split_idx = (c12) % 4;
          out_data = local_cout[c10][c11][c12 / 4];
          for (ap_uint<3> n = 0; n < 4; n++) {
          #pragma HLS UNROLL
          ...
          out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);          local_cout[c10][c11][c12 / 4] = out_data;
        }
      }
    }
  }
...
#pragma HLS DATAFLOW
  ...
  /* FIFO Declaration */
  /* cin_IO_L3_in_serialize fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L3_in_serialize;
  ...
  /* cin_IO_L2_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L2_in_0;
  ...
  /* cin_IO_L2_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L2_in_1;
  ...
  /* cin_IO_L2_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L2_in_2;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L1_in_0_0;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L1_in_0_1;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L1_in_0_2;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L1_in_0_3;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L1_in_0_4;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L1_in_1_0;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L1_in_1_1;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L1_in_1_2;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L1_in_1_3;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t4> fifo_cin_cin_IO_L1_in_1_4;
