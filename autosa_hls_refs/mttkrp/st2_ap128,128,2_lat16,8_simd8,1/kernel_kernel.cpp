// AutoSA Command:
// /workspaces/mlir-systolic/third_party/AutoSA/autosa /workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/mttkrp/kernel.c --config=/workspaces/mlir-systolic/third_party/AutoSA/autosa_config/autosa_config.json --target=autosa_hls_c --output-dir=/workspaces/mlir-systolic/third_party/AutoSA/autosa.tmp/output --host-serialize --simd-info=/workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/mttkrp/simd_info.json --sa-sizes={kernel[]->space_time[2];kernel[]->array_part[128,128,2];kernel[]->latency[16,8];kernel[]->simd[8,1]}
...
extern "C" {
void kernel0(A_t16 *A, B_t2 *B, C_t16 *C, D_t2 *D_0, D_t2 *D_1, D_t2 *D_2);
}
void A_IO_L1_in_intra_trans(int idx, int c0, int c1, int c2, A_t8 local_A[128][1][32], hls::stream<A_t8> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L1_in_inter_trans(int idx, int c0, int c1, int c2, A_t8 local_A[128][1][32], hls::stream<A_t8> &fifo_A_in, hls::stream<A_t8> &fifo_A_out, bool inter_trans_en);
void A_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c2, A_t8 local_A[128][1][32], hls::stream<A_t8> &fifo_A_in, bool inter_trans_en);
...
void B_IO_L1_in_intra_trans(int idx, int c0, int c1, int c2, B_t2 local_B[1][1], hls::stream<float> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L1_in_inter_trans(int idx, int c0, int c1, int c2, B_t2 local_B[1][1], hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, bool inter_trans_en);
void B_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c2, B_t2 local_B[1][1], hls::stream<B_t2> &fifo_B_in, bool inter_trans_en);
void B_IO_L1_in_wrapper(int idx, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<float> &fifo_B_local_out);
void B_IO_L1_in_boundary_wrapper(int idx, hls::stream<B_t2> &fifo_B_in, hls::stream<float> &fifo_B_local_out);
void C_IO_L1_in_intra_trans(int idx, int c0, int c1, C_t8 local_C[2][32], hls::stream<C_t8> &fifo_C_local_out, bool intra_trans_en);
void C_IO_L1_in_inter_trans(int idx, int c0, int c1, C_t8 local_C[2][32], hls::stream<C_t8> &fifo_C_in, hls::stream<C_t8> &fifo_C_out, bool inter_trans_en);
void C_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, C_t8 local_C[2][32], hls::stream<C_t8> &fifo_C_in, bool inter_trans_en);
...
void D_1_IO_L2_in_intra_trans(int c0, int c1, D_t2 *D, D_t2 local_D_1[128][1], hls::stream<float> &fifo_D_1_local_out, bool intra_trans_en);
...
void D_1_IO_L2_out_intra_trans(int c0, int c1, D_t2 *D, D_t2 local_D_1[128][1], hls::stream<float> &fifo_D_1_local_in, bool intra_trans_en);
void D_1_IO_L2_out_inter_trans_boundary(int c0, int c1, D_t2 *D, D_t2 local_D_1[128][1], hls::stream<D_t2> &fifo_D_1_out, bool inter_trans_en);
void D_drain_IO_L1_out_intra_trans(int idx, int c0, int c1, D_t2 local_D[128][1], hls::stream<float> &fifo_D_drain_local_in);
void D_drain_IO_L1_out_inter_trans(int idx, int c0, int c1, D_t2 local_D[128][1], hls::stream<D_t2> &fifo_D_drain_in, hls::stream<D_t2> &fifo_D_drain_out);
void D_drain_IO_L1_out_inter_trans_boundary(int idx, int c0, int c1, D_t2 local_D[128][1], hls::stream<D_t2> &fifo_D_drain_out);
...
/* Module Definition */
void A_IO_L2_in(A_t16 *A, hls::stream<A_t8> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  ...
  for (ap_uint<2> c0 = 0; c0 <= 1; c0 += 1)
    for (ap_uint<9> c1 = 0; c1 <= 167; c1 += 1)
            ...
            #pragma HLS PIPELINE II=1
              {
                ...
                A_t8 out_data;
                if (c6 % 2 == 0) {
                  in_data = A[(((128 * c0 + c4) * 256 + (128 * c2 + c3)) * 256 + 8 * c6) / 16];
                ...
                int split_idx = (1048576*c0 + 4096*c2 + 32*c3 + 8192*c4 + c6) % 2;
...
/* Module Definition */
void B_IO_L2_in(B_t2 *B, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L1_in(int idx, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<float> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t2 local_B_ping[1][1];
  #pragma HLS RESOURCE variable=local_B_ping core=RAM_2P_BRAM
  B_t2 local_B_pong[1][1];
...
/* Module Definition */
void B_IO_L1_in_boundary(int idx, hls::stream<B_t2> &fifo_B_in, hls::stream<float> &fifo_B_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t2 local_B_ping[1][1];
...
/* Module Definition */
void C_IO_L2_in(C_t16 *C, hls::stream<C_t8> &fifo_C_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  C_t8 data_split[2];
  #pragma HLS ARRAY_PARTITION variable=data_split complete
          ...
          #pragma HLS PIPELINE II=1
            {
              ...
              int split_idx = (64*c1 + 32*c4 + c5) % 2;
              out_data = data_split[split_idx];
    ...
    for (ap_uint<2> c7 = 0; c7 <= 1; c7 += 1) {
      ...
      #pragma HLS PIPELINE II=1
        // simd
        {
          D_t2 in_data;
          D_t1 out_data;
          in_data = local_D_1[16*c4 + c8][c7 / 2];
          for (ap_uint<2> n = 0; n < 2; n++) {
          #pragma HLS UNROLL
            data_split[n] = in_data(31, 0);
            in_data = in_data >> 32;
...
/* Module Definition */
void D_1_IO_L2_in_boundary(D_t2 *D, hls::stream<float> &fifo_D_1_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  D_t2 local_D_1_ping[128][1];
  #pragma HLS RESOURCE variable=local_D_1_ping core=RAM_2P_BRAM
  D_t2 local_D_1_pong[128][1];
              ...
              #pragma HLS PIPELINE II=1
                {
                  ...
                  if (p0 + 128 * c2 >= 1 && c6 == 0)
                    local_D[16*c4 + c8][c7] = fifo_D_1_in.read();
                  // simd
                  for (ap_uint<4> c9 = 0; c9 <= 7; c9 += 1) {
                  #pragma HLS UNROLL
                    local_D[16*c4 + c8][c7] = (local_D[16*c4 + c8][c7] + ((local_A[0][0][c9] * local_B[0][0]) * local_C[0][c9]));
                  }
                  if (p0 == 127 && c2 == 1 && c6 == 31) {
                    fifo_D_drain_out.write(local_D[16*c4 + c8][c7]);
                  } else if (p0 + 128 * c2 <= 254 && c6 == 31) {
                    fifo_D_1_out.write(local_D[16*c4 + c8][c7]);
                  }
                }
              }
            }
    ...
    for (ap_uint<2> c7 = 0; c7 <= 1; c7 += 1) {
      ...
      #pragma HLS PIPELINE II=1
        // simd
        {
          ...
          int split_idx = (c7) % 2;
          out_data = local_D_1[16*c4 + c8][c7 / 2];
          for (ap_uint<2> n = 0; n < 2; n++) {
          #pragma HLS UNROLL
          ...
          out_data = (data_split[1], data_split[0]);          local_D_1[16*c4 + c8][c7 / 2] = out_data;
        }
      }
    }
  }
...
#pragma HLS INLINE OFF
  ...
  #pragma HLS PIPELINE II=1
    // access_coalesce
    {
      D_t2 in_data;
      D_t2 out_data;
      in_data = local_D_1[c3][0];
      out_data = in_data;
      D[21504*c0 + c1 + 168*c3] = out_data;
    }
  }
}
/* Module Definition */
...
/* Module Definition */
void D_1_IO_L2_out_boundary(D_t2 *D, hls::stream<float> &fifo_D_1_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  D_t2 local_D_1_ping[128][1];
  #pragma HLS RESOURCE variable=local_D_1_ping core=RAM_2P_BRAM
    ...
    for (ap_uint<2> c7 = 0; c7 <= 1; c7 += 1) {
      ...
      #pragma HLS PIPELINE II=1
        // simd
        {
          ...
          int split_idx = (c7) % 2;
          out_data = local_D[16*c4 + c8][c7 / 2];
          for (ap_uint<2> n = 0; n < 2; n++) {
          #pragma HLS UNROLL
            data_split[n] = out_data(31, 0);
            out_data = out_data >> 32;
          ...
          u.ut = in_data;
          data_split[split_idx] = ap_uint<32>(u.ui);
          out_data = (data_split[1], data_split[0]);          local_D[16*c4 + c8][c7 / 2] = out_data;
        }
      }
    }
  }
...
/* Module Definition */
void D_drain_IO_L2_out(D_t2 *D, hls::stream<D_t2> &fifo_D_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
#pragma HLS DATAFLOW
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_17;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_18;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_19;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_20;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_21;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_22;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_23;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_24;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_25;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_26;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_27;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_28;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_29;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_30;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_31;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_32;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_33;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_34;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_35;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_36;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_37;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_38;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_39;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_40;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_41;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_42;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_43;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_44;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_45;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_46;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_47;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_48;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_49;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_50;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_51;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_52;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_53;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_54;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_55;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_56;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_57;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_58;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_59;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_60;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_61;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_62;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_63;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_64;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_65;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_66;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_67;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_68;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_69;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_70;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_71;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_72;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_73;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_74;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_75;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_76;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_77;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_78;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_79;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_80;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_81;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_82;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_83;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_84;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_85;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_86;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_87;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_88;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_89;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_90;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_91;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_92;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_93;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_94;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_95;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_96;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_97;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_98;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_99;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_100;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_101;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_102;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_103;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_104;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_105;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_106;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_107;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_108;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_109;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_110;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_111;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_112;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_113;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_114;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_115;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_116;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_117;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_118;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_119;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_120;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_121;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_122;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_123;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_124;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_125;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_126;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_127;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_128;
