// AutoSA Command:
// /workspaces/mlir-systolic/third_party/AutoSA/autosa /workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/mttkrp/kernel.c --config=/workspaces/mlir-systolic/third_party/AutoSA/autosa_config/autosa_config.json --target=autosa_hls_c --output-dir=/workspaces/mlir-systolic/third_party/AutoSA/autosa.tmp/output --host-serialize --simd-info=/workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/mttkrp/simd_info.json --sa-sizes={kernel[]->space_time[3];kernel[]->array_part[32,32,2];kernel[]->latency[4,2];kernel[]->simd[2,1]}
...
void A_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, A_t16 local_A[4][2][16], hls::stream<A_t2> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, A_t16 local_A[4][2][16], hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, bool inter_trans_en);
void A_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, A_t16 local_A[4][2][16], hls::stream<A_t16> &fifo_A_in, bool inter_trans_en);
void B_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, B_t2 local_B[2][1], hls::stream<float> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, B_t2 local_B[2][1], hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, bool inter_trans_en);
void B_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, B_t2 local_B[2][1], hls::stream<B_t2> &fifo_B_in, bool inter_trans_en);
void C_IO_L2_in_intra_trans(int idx, int c0, int c1, C_t16 local_C[2][16], hls::stream<C_t2> &fifo_C_local_out, bool intra_trans_en);
void C_IO_L2_in_inter_trans(int idx, int c0, int c1, C_t16 local_C[2][16], hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
void C_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, C_t16 local_C[2][16], hls::stream<C_t16> &fifo_C_in, bool inter_trans_en);
...
void D_drain_IO_L1_out_intra_trans(int idx, int idy, int c0, int c1, D_t2 local_D[4][1], hls::stream<float> &fifo_D_drain_local_in);
void D_drain_IO_L1_out_inter_trans(int idx, int idy, int c0, int c1, D_t2 local_D[4][1], hls::stream<D_t2> &fifo_D_drain_in, hls::stream<D_t2> &fifo_D_drain_out);
void D_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, int c0, int c1, D_t2 local_D[4][1], hls::stream<D_t2> &fifo_D_drain_out);
...
#pragma HLS INLINE OFF
  ...
  for (ap_uint<25> i = 0; i < 11534336; i++) {
  #pragma HLS PIPELINE II=1
    A_t16 fifo_data;
    fifo_data = A[i];
  ...
  for (ap_uint<4> c0 = 0; c0 <= 7; c0 += 1)
    for (ap_uint<5> c1 = 0; c1 <= 10; c1 += 1)
      for (ap_uint<8> c2 = 0; c2 <= 127; c2 += 1) {
        // array
        // io_L3
        for (int c3 = 0; c3 <= min(15, -16 * c1 + 167); c3 += 1) {
          // io_L2
...
#pragma HLS INLINE OFF
  ...
  for (int c3 = p0; c3 <= min(15, -16 * c1 + 167); c3 += 1) {
    // io_L2
    if (c3 == p0) {
      for (ap_uint<2> c4 = 0; c4 <= 1; c4 += 1) {
      #pragma HLS PIPELINE II=1
...
#pragma HLS INLINE OFF
  ...
  for (ap_uint<24> i = 0; i < 5505024; i++) {
  #pragma HLS PIPELINE II=1
    C_t16 fifo_data;
    fifo_data = C[i];
...
#pragma HLS INLINE OFF
  ...
  D_t1 local_D[4][2];
  #pragma HLS ARRAY_PARTITION variable=local_D dim=0 complete
  /* Variable Declaration */
  ...
  for (ap_uint<2> c7 = 0; c7 <= 1; c7 += 1) {
    ...
    #pragma HLS PIPELINE II=1
      // simd
      {
        ...
        out_data = (data_split[1], data_split[0]);        local_D[c8][c7 / 2] = out_data;
      }
    }
  }
}
...
#pragma HLS DATAFLOW
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_8_0;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_8_1;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_8_2;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_8_3;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_8_4;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_8_5;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_8_6;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_8_7;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_8_8;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_9_0;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_9_1;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_9_2;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_9_3;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_9_4;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_9_5;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_9_6;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_9_7;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_9_8;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_10_0;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_10_1;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_10_2;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_10_3;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_10_4;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_10_5;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_10_6;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_10_7;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_10_8;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_11_0;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_11_1;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_11_2;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_11_3;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_11_4;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_11_5;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_11_6;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_11_7;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_11_8;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_12_0;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_12_1;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_12_2;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_12_3;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_12_4;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_12_5;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_12_6;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_12_7;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_12_8;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_13_0;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_13_1;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_13_2;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_13_3;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_13_4;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_13_5;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_13_6;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_13_7;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_13_8;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_14_0;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_14_1;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_14_2;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_14_3;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_14_4;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_14_5;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_14_6;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_14_7;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_14_8;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_15_0;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_15_1;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_15_2;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_15_3;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_15_4;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_15_5;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_15_6;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_15_7;
  ...
  /* D_drain_IO_L1_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L1_out_15_8;
  ...
  /* D_drain_IO_L2_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L2_out_9;
  ...
  /* D_drain_IO_L2_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L2_out_10;
  ...
  /* D_drain_IO_L2_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L2_out_11;
  ...
  /* D_drain_IO_L2_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L2_out_12;
  ...
  /* D_drain_IO_L2_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L2_out_13;
  ...
  /* D_drain_IO_L2_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L2_out_14;
  ...
  /* D_drain_IO_L2_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L2_out_15;
  ...
  /* D_drain_IO_L2_out fifo */ hls::stream<D_t2> fifo_D_drain_D_drain_IO_L2_out_16;
