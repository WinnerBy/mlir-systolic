...
//      C[l][j] = 2.5;
  ...
  // computation
  {
    ...
    std::vector<float, aligned_allocator<float>> dev_A(184549376);
    std::vector<float, aligned_allocator<float>> dev_B_unserialized((256) * (336));
    std::vector<float, aligned_allocator<float>> dev_B(688128);
    std::vector<float, aligned_allocator<float>> dev_C_unserialized((336) * (256));
    std::vector<float, aligned_allocator<float>> dev_C(88080384);
