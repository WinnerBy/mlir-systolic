...
//      C[l][j] = 2.5;
  ...
  // computation
  {
    ...
    std::vector<float, aligned_allocator<float>> dev_A(100663296);
    std::vector<float, aligned_allocator<float>> dev_B_unserialized((256) * (336));
    std::vector<float, aligned_allocator<float>> dev_B(344064);
    std::vector<float, aligned_allocator<float>> dev_C_unserialized((336) * (256));
    std::vector<float, aligned_allocator<float>> dev_C(44040192);
