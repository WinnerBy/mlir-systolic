...
{
  {
    ...
    std::vector<float, aligned_allocator<float>> dev_L(961);
    std::vector<float, aligned_allocator<float>> dev_U_unserialized((32) * (32));
    std::vector<float, aligned_allocator<float>> dev_U(528);
