// AutoSA Command:
// /workspaces/mlir-systolic/third_party/AutoSA/autosa /workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/lu/kernel.c --config=/workspaces/mlir-systolic/third_party/AutoSA/autosa_config/autosa_config.json --target=autosa_hls_c --output-dir=/workspaces/mlir-systolic/third_party/AutoSA/autosa.tmp/output --host-serialize --simd-info=/workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/lu/simd_info.json --sa-sizes={kernel[]->space_time[2];kernel[]->array_part[-1,-1,-1];kernel[]->latency[8,8];kernel[]->simd[2,2]} --use-cplusplus-template --no-reschedule --live-range-reordering
...
typedef float L_t1;
typedef float U_t1;
typedef ap_uint<128> prev_V_t4;
typedef ap_uint<128> U_tmp_t4;
typedef ap_uint<512> A_t16;
typedef ap_uint<128> A_t4;
typedef ap_uint<512> L_t16;
typedef ap_uint<512> U_t16;
/* Data Type */

extern "C" {
void kernel0(A_t16 *A, L_t16 *L, U_t16 *U);
}
template<int p0>
void A_IO_L1_in_intra_trans(A_t4 local_A[1][8], hls::stream<float> &fifo_A_local_out);
template<int p0>
void A_IO_L1_in_inter_trans(A_t4 local_A[1][8], hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_out);
template<int p0>
void A_IO_L1_in_inter_trans_boundary(A_t4 local_A[1][8], hls::stream<A_t4> &fifo_A_in);
template<int p0>
void A_IO_L1_in_wrapper(hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_out, hls::stream<float> &fifo_A_local_out);
template<int p0>
void A_IO_L1_in_boundary_wrapper(hls::stream<A_t4> &fifo_A_in, hls::stream<float> &fifo_A_local_out);
template<int p0>
void PE_wrapper(hls::stream<float> &fifo_L_tmp_0_in, hls::stream<float> &fifo_L_tmp_0_out, hls::stream<float> &fifo_A_in, hls::stream<float> &fifo_L_drain_out, hls::stream<float> &fifo_U_drain_out);
template<int p0>
void L_drain_IO_L1_out_intra_trans(float local_L[1][31], hls::stream<float> &fifo_L_drain_local_in);
template<int p0>
void L_drain_IO_L1_out_inter_trans(float local_L[1][31], hls::stream<float> &fifo_L_drain_in, hls::stream<float> &fifo_L_drain_out);
template<int p0>
void L_drain_IO_L1_out_inter_trans_boundary(float local_L[1][31], hls::stream<float> &fifo_L_drain_out);
template<int p0>
...
template<int p0>
void U_drain_IO_L1_out_intra_trans(float local_U[32][1], hls::stream<float> &fifo_U_drain_local_in);
template<int p0>
void U_drain_IO_L1_out_inter_trans(float local_U[32][1], hls::stream<float> &fifo_U_drain_in, hls::stream<float> &fifo_U_drain_out);
template<int p0>
void U_drain_IO_L1_out_inter_trans_boundary(float local_U[32][1], hls::stream<float> &fifo_U_drain_out);
template<int p0>
void U_drain_IO_L1_out_wrapper(hls::stream<float> &fifo_U_drain_in, hls::stream<float> &fifo_U_drain_out, hls::stream<float> &fifo_U_drain_local_in);
template<int p0>
void U_drain_IO_L1_out_boundary_wrapper(hls::stream<float> &fifo_U_drain_out, hls::stream<float> &fifo_U_drain_local_in);
...
/* Module Definition */
template<int p0>
void A_IO_L1_in(hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_out, hls::stream<float> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  A_t4 local_A[1][8];
...
/* Module Definition */
template<int p0>
void A_IO_L1_in_boundary(hls::stream<A_t4> &fifo_A_in, hls::stream<float> &fifo_A_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  A_t4 local_A[1][8];
  #pragma HLS RESOURCE variable=local_A core=RAM_2P_BRAM
...
/* Module Definition */
template<int p0>
void PE(hls::stream<float> &fifo_L_tmp_0_in, hls::stream<float> &fifo_L_tmp_0_out, hls::stream<float> &fifo_A_in, hls::stream<float> &fifo_L_drain_out, hls::stream<float> &fifo_U_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  prev_V_t1 local_prev_V[1][32];
  #pragma HLS RESOURCE variable=local_prev_V core=RAM_2P_BRAM
  V_t1 local_V[1][31];
  #pragma HLS RESOURCE variable=local_V core=RAM_2P_BRAM
  U_tmp_t1 local_U_tmp[1][32];
  #pragma HLS RESOURCE variable=local_U_tmp core=RAM_2P_BRAM
  L_tmp_t1 local_L_tmp[2][31];
  ...
  // array
  // pe
  for (int c1 = 0; c1 <= p0 / 2; c1 += 1)
    for (ap_uint<5> c2 = c1; c2 <= 15; c2 += 1) {
      // simd
      for (ap_uint<2> c3 = 0; c3 <= 1; c3 += 1) {
      #pragma HLS PIPELINE II=1
      #pragma HLS UNROLL
        {
          if (p0 >= 2 * c1 + 1 && 2 * c2 + c3 >= 2 * c1 + 1)
            local_L_tmp[0][2*c2 + c3 - 1] = fifo_L_tmp_0_in.read();
          if (c1 == 0)
          ...
          // simd
          {
            if (c1 == 0) {
              // hls_unroll
              local_prev_V[0][2*c2 + c3] = local_A[0][0];
            }
            if (2 * c2 + c3 >= 1)
              for (int c4 = 0; c4 <= min(min(1, p0 - 2 * c1), -2 * c1 + 2 * c2 + c3); c4 += 1) {
              #pragma HLS PIPELINE II=1
              #pragma HLS UNROLL
              #pragma HLS UNROLL
              #pragma HLS PIPELINE II=1
              #pragma HLS UNROLL
                {
                  if (2 * c1 + c4 >= 1)
                    local_prev_V[0][2*c2 + c3] = local_V[0][2*c2 + c3 - 1];
                  if (2 * c2 + c3 >= 2 * c1 + c4 + 1) {
                    local_U_tmp[0][2*c2 + c3] = local_U_tmp[0][2*c2 + c3 - 1];
                    if (2 * c1 + c4 == p0) {
                      local_L_tmp[1][2*c2 + c3 - 1] = (local_prev_V[0][2*c2 + c3] / local_U_tmp[0][2*c2 + c3]);
                      local_L[0][0] = local_L_tmp[1][2*c2 + c3 - 1];
                    } else if (p0 >= 2 * c1 + c4 + 1) {
                      local_L_tmp[1][2*c2 + c3 - 1] = local_L_tmp[0][2*c2 + c3 - 1];
                    }
                    local_V[0][2*c2 + c3 - 1] = (local_prev_V[0][2*c2 + c3] - (local_L_tmp[1][2*c2 + c3 - 1] * local_U_tmp[0][2*c2 + c3]));
                  }
                }
              }
            if (c2 == c1 && p0 >= 2 * c1 + c3) {
              // hls_pipeline
              local_U_tmp[0][2*c1 + c3] = local_prev_V[0][2*c1 + c3];
              local_U[0][0] = local_U_tmp[0][2*c1 + c3];
            }
          }
          if (c2 == c1 && p0 >= 2 * c1 + c3) {
            fifo_U_drain_out.write(local_U[0][0]);
          } else if (2 * c1 + 1 >= p0 && 2 * c2 + c3 >= p0 + 1) {
            fifo_L_drain_out.write(local_L[0][0]);
          }
          if (p0 <= 30 && p0 >= 2 * c1 + 1 && 2 * c2 + c3 >= 2 * c1 + 1)
            fifo_L_tmp_0_out.write(local_L_tmp[1][2*c2 + c3 - 1]);
          if (2 * c1 + 1 >= p0 && 2 * c2 + c3 >= p0 + 1)
            fifo_L_tmp_0_out.write(local_L_tmp[1][2*c2 + c3 - 1]);
        }
      }
    }
...
void PE_wrapper(hls::stream<float> &fifo_L_tmp_0_in, hls::stream<float> &fifo_L_tmp_0_out, hls::stream<float> &fifo_A_in, hls::stream<float> &fifo_L_drain_out, hls::stream<float> &fifo_U_drain_out)
 {
  PE<p0>(
    /* fifo */ fifo_L_tmp_0_in, 
    /* fifo */ fifo_L_tmp_0_out, 
    /* fifo */ fifo_A_in, 
...
#pragma HLS INLINE
  ...
  // io_L1
  // pe
  for (ap_uint<5> c2 = p0 - p0 / 2; c2 <= 15; c2 += 1) {
  #pragma HLS PIPELINE II=1
    // simd
    // simd
    // hls_pipeline
...
#pragma HLS INLINE
  ...
  for (ap_uint<6> c0 = p0; c0 <= 30; c0 += 1) {
    // io_L1
    if (c0 == p0) {
      // access_coalesce
      for (int c2 = 0; c2 <= -p0 + 30; c2 += 1) {
      #pragma HLS PIPELINE II=1
        {
          L_t1 in_data;
          L_t1 out_data;
          in_data = local_L[0][c2];
          out_data = in_data;
...
/* Module Definition */
void L_drain_IO_L2_out_serialize(L_t16 *L, hls::stream<float> &fifo_L_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void U_drain_IO_L2_out(hls::stream<float> &fifo_U_drain_out, hls::stream<float> &fifo_U_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void U_drain_IO_L2_out_serialize(U_t16 *U, hls::stream<float> &fifo_U_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
#pragma HLS DATAFLOW
  ...
  /* U_drain_IO_L2_out_serialize fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L2_out_serialize;
  ...
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_0;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_0 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_0 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_1;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_1 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_1 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_2;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_2 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_2 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_3;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_3 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_3 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_4;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_4 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_4 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_5;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_5 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_5 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_6;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_6 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_6 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_7;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_7 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_7 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_8;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_8 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_8 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_9;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_9 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_9 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_10;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_10 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_10 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_11;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_11 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_11 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_12;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_12 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_12 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_13;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_13 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_13 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_14;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_14 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_14 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_15;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_15 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_15 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_16;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_16 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_16 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_17;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_17 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_17 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_18;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_18 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_18 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_19;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_19 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_19 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_20;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_20 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_20 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_21;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_21 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_21 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_22;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_22 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_22 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_23;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_23 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_23 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_24;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_24 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_24 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_25;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_25 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_25 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_26;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_26 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_26 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_27;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_27 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_27 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_28;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_28 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_28 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_29;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_29 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_29 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_30;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_30 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_30 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_31;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_31 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_31 core=FIFO_SRL
  /* PE fifo */ hls::stream<float> fifo_L_tmp_0_PE_32;
  #pragma HLS STREAM variable=fifo_L_tmp_0_PE_32 depth=2
  #pragma HLS RESOURCE variable=fifo_L_tmp_0_PE_32 core=FIFO_SRL
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_0;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_1;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_2;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_3;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_4;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_5;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_6;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_7;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_8;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_9;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_10;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_11;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_12;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_13;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_14;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_15;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_16;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_17;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_18;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_19;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_20;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_21;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_22;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_23;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_24;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_25;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_26;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_27;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_28;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_29;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_30;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_31;
  ...
  /* U_drain_IO_L1_out fifo */ hls::stream<float> fifo_U_drain_U_drain_IO_L1_out_32;
  ...
  /* Module Call */
  PE_wrapper<0>(
    /* fifo */ fifo_L_tmp_0_PE_0,
    /* fifo */ fifo_L_tmp_0_PE_1,
    /* fifo */ fifo_A_PE_0,
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary_wrapper<30>(
