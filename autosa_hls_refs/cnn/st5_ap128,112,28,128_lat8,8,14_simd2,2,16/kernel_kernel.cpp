...
void cin_IO_L2_in_intra_trans(int idx, int c0, int c1, int c3, cin_t16 local_cin[30][10][8], hls::stream<cin_t16> &fifo_cin_local_out, bool intra_trans_en);
void cin_IO_L2_in_inter_trans(int idx, int c0, int c1, int c3, cin_t16 local_cin[30][10][8], hls::stream<cin_t16> &fifo_cin_in, hls::stream<cin_t16> &fifo_cin_out, bool inter_trans_en);
void cin_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c3, cin_t16 local_cin[30][10][8], hls::stream<cin_t16> &fifo_cin_in, bool inter_trans_en);
void w_IO_L1_in_intra_trans(int idx, int idy, int c0, int c1, int c3, w_t16 local_w[8][3][3][8], hls::stream<w_t16> &fifo_w_local_out, bool intra_trans_en);
void w_IO_L1_in_inter_trans(int idx, int idy, int c0, int c1, int c3, w_t16 local_w[8][3][3][8], hls::stream<w_t16> &fifo_w_in, hls::stream<w_t16> &fifo_w_out, bool inter_trans_en);
void w_IO_L1_in_inter_trans_boundary(int idx, int idy, int c0, int c1, int c3, w_t16 local_w[8][3][3][8], hls::stream<w_t16> &fifo_w_in, bool inter_trans_en);
void w_IO_L1_in_wrapper(int idx, int idy, hls::stream<w_t16> &fifo_w_in, hls::stream<w_t16> &fifo_w_out, hls::stream<w_t16> &fifo_w_local_out);
void w_IO_L1_in_boundary_wrapper(int idx, int idy, hls::stream<w_t16> &fifo_w_in, hls::stream<w_t16> &fifo_w_local_out);
void PE_wrapper(int idx, int idy, hls::stream<cin_t16> &fifo_cin_in, hls::stream<cin_t16> &fifo_cin_out, hls::stream<float> &fifo_cout_drain_out, hls::stream<w_t16> &fifo_w_in);
void cout_drain_IO_L1_out_intra_trans(int idx, int idy, int c0, int c1, cout_t4 local_cout[28][8][2], hls::stream<float> &fifo_cout_drain_local_in);
void cout_drain_IO_L1_out_inter_trans(int idx, int idy, int c0, int c1, cout_t4 local_cout[28][8][2], hls::stream<cout_t4> &fifo_cout_drain_in, hls::stream<cout_t4> &fifo_cout_drain_out);
void cout_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, int c0, int c1, cout_t4 local_cout[28][8][2], hls::stream<cout_t4> &fifo_cout_drain_out);
            ...
            for (ap_uint<4> c11 = 0; c11 <= 7; c11 += 1) {
              ...
              #pragma HLS PIPELINE II=1
                // simd
                {
                  cin_t16 in_data;
                  cin_t16 out_data;
                  in_data = local_cin[c10 + 14*c6 + c8][c11 + c9][c7];
                  out_data = in_data;
                  fifo_cin_local_out.write(out_data);
                }
              }
...
/* Module Definition */
void w_IO_L1_in(int idx, int idy, hls::stream<w_t16> &fifo_w_in, hls::stream<w_t16> &fifo_w_out, hls::stream<w_t16> &fifo_w_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  w_t16 local_w_ping[8][3][3][8];
  #pragma HLS RESOURCE variable=local_w_ping core=RAM_1P_BRAM
  w_t16 local_w_pong[8][3][3][8];
...
/* Module Definition */
void w_IO_L1_in_boundary(int idx, int idy, hls::stream<w_t16> &fifo_w_in, hls::stream<w_t16> &fifo_w_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  w_t16 local_w_ping[8][3][3][8];
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<cin_t16> &fifo_cin_in, hls::stream<cin_t16> &fifo_cin_out, hls::stream<float> &fifo_cout_drain_out, hls::stream<w_t16> &fifo_w_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
                    ...
                    #pragma HLS PIPELINE II=1
                      {
                        ...
                        #pragma HLS UNROLL
                          local_cout[c10 + 14*c6][c11][c12] = (local_cout[c10 + 14*c6][c11][c12] + (local_cin[0][0][c13] * local_w[0][0][0][c13]));
                        }
                        if (c3 == 3 && c7 == 7 && c8 == 2 && c9 == 2)
                          fifo_cout_drain_out.write(local_cout[c10 + 14*c6][c11][c12]);
                        {
                          cin_t16 fifo_data;
                          union {unsigned int ui; float ut;} u15, u14, u13, u12, u11, u10, u9, u8, u7, u6, u5, u4, u3, u2, u1, u0;
                          u15.ut = local_cin[0][0][15];
                          u14.ut = local_cin[0][0][14];
                          u13.ut = local_cin[0][0][13];
                          u12.ut = local_cin[0][0][12];
                          u11.ut = local_cin[0][0][11];
                          u10.ut = local_cin[0][0][10];
                          u9.ut = local_cin[0][0][9];
                          u8.ut = local_cin[0][0][8];
...
/* Module Definition */
void cin_PE_dummy_in(int idx, int idy, hls::stream<cin_t16> &fifo_cin_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
      ...
      for (ap_uint<4> c11 = 0; c11 <= 7; c11 += 1) {
        ...
        #pragma HLS PIPELINE II=1
          // simd
          {
            ...
            int split_idx = (c12) % 4;
            out_data = local_cout[c10 + 14*c6][c11][c12 / 4];
            ...
            out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);            local_cout[c10 + 14*c6][c11][c12 / 4] = out_data;
          }
        }
      }
    }
...
#pragma HLS DATAFLOW
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_0_11;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_0_12;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_0_13;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_0_14;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_0_15;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_0_16;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_1_11;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_1_12;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_1_13;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_1_14;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_1_15;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_1_16;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_2_11;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_2_12;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_2_13;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_2_14;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_2_15;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_2_16;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_3_11;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_3_12;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_3_13;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_3_14;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_3_15;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_3_16;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_4_11;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_4_12;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_4_13;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_4_14;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_4_15;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_4_16;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_5_11;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_5_12;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_5_13;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_5_14;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_5_15;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_5_16;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_6_11;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_6_12;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_6_13;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_6_14;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_6_15;
  ...
  /* w_IO_L1_in fifo */ hls::stream<w_t16> fifo_w_w_IO_L1_in_6_16;
