// AutoSA Command:
// /workspaces/mlir-systolic/third_party/AutoSA/autosa /workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/cnn/kernel.c --config=/workspaces/mlir-systolic/third_party/AutoSA/autosa_config/autosa_config.json --target=autosa_hls_c --output-dir=/workspaces/mlir-systolic/third_party/AutoSA/autosa.tmp/output --host-serialize --simd-info=/workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/cnn/simd_info.json --sa-sizes={kernel[]->space_time[1];kernel[]->array_part[64,56,14,64];kernel[]->latency[4,4,7];kernel[]->simd[1,1,8]}
...
void cin_IO_L1_in_intra_trans(int idx, int c0, int c2, int c3, cin_t8 local_cin[6][16][8], hls::stream<cin_t8> &fifo_cin_local_out, bool intra_trans_en);
void cin_IO_L1_in_inter_trans(int idx, int c0, int c2, int c3, cin_t8 local_cin[6][16][8], hls::stream<cin_t8> &fifo_cin_in, hls::stream<cin_t8> &fifo_cin_out, bool inter_trans_en);
void cin_IO_L1_in_inter_trans_boundary(int idx, int c0, int c2, int c3, cin_t8 local_cin[6][16][8], hls::stream<cin_t8> &fifo_cin_in, bool inter_trans_en);
void cin_IO_L1_in_wrapper(int idx, hls::stream<cin_t8> &fifo_cin_in, hls::stream<cin_t8> &fifo_cin_out, hls::stream<cin_t8> &fifo_cin_local_out);
void cin_IO_L1_in_boundary_wrapper(int idx, hls::stream<cin_t8> &fifo_cin_in, hls::stream<cin_t8> &fifo_cin_local_out);
void w_IO_L2_in_intra_trans(int c0, int c2, int c3, w_t16 local_w[56][3][3][4], hls::stream<w_t8> &fifo_w_local_out, bool intra_trans_en);
void w_IO_L2_in_inter_trans_boundary(int c0, int c2, int c3, w_t16 local_w[56][3][3][4], hls::stream<w_t16> &fifo_w_in, bool inter_trans_en);
void PE_wrapper(int idx, hls::stream<cin_t8> &fifo_cin_in, hls::stream<float> &fifo_cout_drain_out, hls::stream<w_t8> &fifo_w_in, hls::stream<w_t8> &fifo_w_out);
void cout_drain_IO_L1_out_intra_trans(int idx, int c0, int c2, cout_t4 local_cout[4][14][14], hls::stream<float> &fifo_cout_drain_local_in);
void cout_drain_IO_L1_out_inter_trans(int idx, int c0, int c2, cout_t4 local_cout[4][14][14], hls::stream<cout_t4> &fifo_cout_drain_in, hls::stream<cout_t4> &fifo_cout_drain_out);
void cout_drain_IO_L1_out_inter_trans_boundary(int idx, int c0, int c2, cout_t4 local_cout[4][14][14], hls::stream<cout_t4> &fifo_cout_drain_out);
...
/* Module Definition */
void cin_IO_L2_in(hls::stream<cin_t8> &fifo_cin_in, hls::stream<cin_t8> &fifo_cin_local_out) {
...
/* Module Definition */
void cin_IO_L2_in_serialize(cin_t16 *cin, hls::stream<cin_t8> &fifo_cin_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
  ...
  cin_t8 fifo_data;
  cin_t16 mem_data;
  for (ap_uint<22> i = 0; i < 2064384; i++) {
  #pragma HLS PIPELINE II=1
    mem_data = cin[i];
...
#pragma HLS INLINE OFF
  ...
  // io_L1
  // pe
  for (int c5 = 0; c5 <= min(13, -14 * c0 + 159); c5 += 1)
              ...
              for (ap_uint<3> c11 = 0; c11 <= 3; c11 += 1) {
                ...
                #pragma HLS PIPELINE II=1
                  // simd
                  {
                    cin_t8 in_data;
                    cin_t8 out_data;
                    in_data = local_cin[c12 + c8][c10 + 7*c6 + c9][c7];
                    out_data = in_data;
                    fifo_cin_local_out.write(out_data);
                  }
                }
...
/* Module Definition */
void cin_IO_L1_in(int idx, hls::stream<cin_t8> &fifo_cin_in, hls::stream<cin_t8> &fifo_cin_out, hls::stream<cin_t8> &fifo_cin_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  cin_t8 local_cin_ping[6][16][8];
  #pragma HLS RESOURCE variable=local_cin_ping core=RAM_1P_BRAM
  cin_t8 local_cin_pong[6][16][8];
...
/* Module Definition */
void cin_IO_L1_in_boundary(int idx, hls::stream<cin_t8> &fifo_cin_in, hls::stream<cin_t8> &fifo_cin_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx; // module id
  cin_t8 local_cin_ping[6][16][8];
              ...
              for (ap_uint<3> c11 = 0; c11 <= 3; c11 += 1) {
                ...
                #pragma HLS PIPELINE II=1
                  // simd
                  {
                    w_t16 in_data;
                    w_t8 out_data;
                    in_data = local_w[c11 + 4*c5][c8][c9][8 * c7 / 16];
...
#pragma HLS INLINE OFF
  ...
  // io_L2
  for (int c4 = 0; c4 <= min(55, -56 * c0 + 639); c4 += 1)
...
/* Module Definition */
void w_IO_L2_in_boundary(hls::stream<w_t16> &fifo_w_in, hls::stream<w_t8> &fifo_w_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  w_t16 local_w_ping[56][3][3][4];
  #pragma HLS RESOURCE variable=local_w_ping core=RAM_2P_BRAM
  w_t16 local_w_pong[56][3][3][4];
...
/* Module Definition */
void w_IO_L2_in_boundary_serialize(w_t16 *w, hls::stream<w_t16> &fifo_w_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void PE(int idx, hls::stream<cin_t8> &fifo_cin_in, hls::stream<float> &fifo_cout_drain_out, hls::stream<w_t8> &fifo_w_in, hls::stream<w_t8> &fifo_w_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  cin_t1 local_cin[1][1][8];
  #pragma HLS ARRAY_PARTITION variable=local_cin dim=0 complete
  cout_t1 local_cout[4][14][56];
              ...
              for (ap_uint<4> c8 = 0; c8 <= 6; c8 += 1) {
                ...
                for (ap_uint<3> c9 = 0; c9 <= 3; c9 += 1) {
                  ...
                  #pragma HLS PIPELINE II=1
                    // simd
                    // hls_unroll
                    local_cout[c10][7*c6 + c8][4*c5 + c9] = 0;
                  }
                }
              }
            }
                      ...
                      #pragma HLS PIPELINE II=1
                        {
                          ...
                          #pragma HLS UNROLL
                            local_cout[c12][c10 + 7*c6][c11 + 4*c5] = (local_cout[c12][c10 + 7*c6][c11 + 4*c5] + (local_cin[0][0][c13] * local_w[0][0][0][c13]));
                          }
                          {
                            w_t8 fifo_data;
                          ...
                          if (c3 == 7 && c7 == 7 && c8 == 2 && c9 == 2)
                            fifo_cout_drain_out.write(local_cout[c12][c10 + 7*c6][c11 + 4*c5]);
                        }
                      }
                    }
                  }
...
/* Module Definition */
void w_PE_dummy_in(int idx, hls::stream<w_t8> &fifo_w_in) {
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
        ...
        for (ap_uint<3> c11 = 0; c11 <= 3; c11 += 1) {
          ...
          #pragma HLS PIPELINE II=1
            // simd
            {
              ...
              int split_idx = (c11 + 4*c5) % 4;
              out_data = local_cout[c12][c10 + 7*c6][(4 * c5 + c11) / 4];
              ...
              out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);              local_cout[c12][c10 + 7*c6][(4 * c5 + c11) / 4] = out_data;
            }
          }
        }
      }
    ...
    if (c4 == p0) {
      for (ap_uint<3> c5 = 0; c5 <= 3; c5 += 1)
        for (ap_uint<5> c6 = 0; c6 <= 13; c6 += 1) {
          // access_coalesce
          for (int c7 = 0; c7 <= min(13, -14 * c0 + 159); c7 += 1) {
          #pragma HLS PIPELINE II=1
            {
              cout_t4 in_data;
              cout_t4 out_data;
...
#pragma HLS DATAFLOW
  ...
  /* FIFO Declaration */
  /* cin_IO_L2_in_serialize fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L2_in_serialize;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_0;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_1;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_2;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_3;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_4;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_5;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_6;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_7;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_8;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_9;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_10;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_11;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_12;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_13;
  ...
  /* cin_IO_L1_in fifo */ hls::stream<cin_t8> fifo_cin_cin_IO_L1_in_14;
