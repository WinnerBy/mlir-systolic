...
extern "C" {
void kernel0(cin_t1 *cin, cout_t2 *cout_0, cout_t2 *cout_1, cout_t2 *cout_2, w_t1 *w);
}
void cin_IO_L1_in_intra_trans(int idx, int c0, int c1, int c3, float local_cin[19][58][1], hls::stream<float> &fifo_cin_local_out, bool intra_trans_en);
void cin_IO_L1_in_inter_trans(int idx, int c0, int c1, int c3, float local_cin[19][58][1], hls::stream<float> &fifo_cin_in, hls::stream<float> &fifo_cin_out, bool inter_trans_en);
void cin_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c3, float local_cin[19][58][1], hls::stream<float> &fifo_cin_in, bool inter_trans_en);
...
void cout_1_IO_L2_in_intra_trans(int c0, int c1, int c3, cout_t2 *cout, cout_t2 local_cout_1[17][56][35], hls::stream<float> &fifo_cout_1_local_out, bool intra_trans_en);
void w_IO_L1_in_intra_trans(int idx, int c0, int c1, int c3, float local_w[70][3][3][1], hls::stream<float> &fifo_w_local_out, bool intra_trans_en);
void w_IO_L1_in_inter_trans(int idx, int c0, int c1, int c3, float local_w[70][3][3][1], hls::stream<float> &fifo_w_in, hls::stream<float> &fifo_w_out, bool inter_trans_en);
void w_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c3, float local_w[70][3][3][1], hls::stream<float> &fifo_w_in, bool inter_trans_en);
...
void cout_1_IO_L2_out_intra_trans(int c0, int c1, int c3, cout_t2 *cout, cout_t2 local_cout_1[17][56][35], hls::stream<float> &fifo_cout_1_local_in, bool intra_trans_en);
void cout_1_IO_L2_out_inter_trans_boundary(int c0, int c1, cout_t2 *cout, cout_t2 local_cout_1[17][56][35], hls::stream<cout_t2> &fifo_cout_1_out, bool inter_trans_en);
void cout_drain_IO_L1_out_intra_trans(int idx, int c0, int c1, cout_t2 local_cout[17][56][35], hls::stream<float> &fifo_cout_drain_local_in);
void cout_drain_IO_L1_out_inter_trans(int idx, int c0, int c1, cout_t2 local_cout[17][56][35], hls::stream<cout_t2> &fifo_cout_drain_in, hls::stream<cout_t2> &fifo_cout_drain_out);
void cout_drain_IO_L1_out_inter_trans_boundary(int idx, int c0, int c1, cout_t2 local_cout[17][56][35], hls::stream<cout_t2> &fifo_cout_drain_out);
void cout_drain_IO_L1_out_wrapper(int idx, hls::stream<cout_t2> &fifo_cout_drain_in, hls::stream<cout_t2> &fifo_cout_drain_out, hls::stream<float> &fifo_cout_drain_local_in);
void cout_drain_IO_L1_out_boundary_wrapper(int idx, hls::stream<cout_t2> &fifo_cout_drain_out, hls::stream<float> &fifo_cout_drain_local_in);
...
#pragma HLS INLINE OFF
  ...
  for (ap_uint<5> c0 = 0; c0 <= 9; c0 += 1)
    for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1)
      for (ap_uint<4> c3 = 0; c3 <= 6; c3 += 1) {
        // array
        // io_L2
        for (int c4 = 0; c4 <= min(79, -80 * c3 + 511); c4 += 1) {
          // io_L1
          for (int c5 = 0; c5 <= min(18, -17 * c1 + 57); c5 += 1)
            ...
            #pragma HLS PIPELINE II=1
              // access_coalesce
              {
                cin_t1 in_data;
                cin_t1 out_data;
                in_data = cin[504832*c1 + 80*c3 + c4 + 29696*c5 + 512*c6];
                out_data = in_data;
...
#pragma HLS INLINE OFF
  ...
  // io_L1
  // pe
  for (int c5 = 0; c5 <= min(13, -14 * c0 + 127); c5 += 1)
    for (int c6 = 0; c6 <= min(3, -3 * c1 - (2 * c1 + 4) / 5 + 11); c6 += 1)
      for (ap_uint<4> c7 = 0; c7 <= 6; c7 += 1)
        for (ap_uint<3> c8 = 0; c8 <= 2; c8 += 1)
          for (ap_uint<3> c9 = 0; c9 <= 2; c9 += 1) {
            // latency
            for (ap_uint<4> c10 = 0; c10 <= 7; c10 += 1) {
              // latency
              for (int c11 = 0; c11 <= min(4, -5 * c6 + 16); c11 += 1) {
                // latency
                for (ap_uint<4> c12 = 0; c12 <= 4; c12 += 1) {
                #pragma HLS PIPELINE II=1
                  {
                    cin_t1 in_data;
                    cin_t1 out_data;
                    in_data = local_cin[c11 + 5*c6 + c8][c10 + 8*c7 + c9][0];
                    out_data = in_data;
                    fifo_cin_local_out.write(out_data);
                  }
                }
...
#pragma HLS INLINE OFF
  ...
  for (int c4 = p0; c4 <= min(79, -80 * c3 + 511); c4 += 1) {
    // io_L1
    if (c4 == p0) {
      for (int c5 = 0; c5 <= min(18, -17 * c1 + 57); c5 += 1)
        for (ap_uint<7> c6 = 0; c6 <= 57; c6 += 1) {
            ...
            #pragma HLS PIPELINE II=1
              {
                cout_t2 in_data;
                cout_t1 out_data;
                in_data = local_cout_1[c11 + 5*c6][c10 + 8*c7][(5 * c5 + c12) / 2];
                for (ap_uint<2> n = 0; n < 2; n++) {
                #pragma HLS UNROLL
                  data_split[n] = in_data(31, 0);
                  in_data = in_data >> 32;
                }
                int split_idx = (c12 + 5*c5) % 2;
...
/* Module Definition */
void cout_1_IO_L2_in_boundary(cout_t2 *cout, hls::stream<float> &fifo_cout_1_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  cout_t2 local_cout_1_ping[17][56][35];
  #pragma HLS RESOURCE variable=local_cout_1_ping core=RAM_2P_BRAM
  cout_t2 local_cout_1_pong[17][56][35];
  ...
  for (ap_uint<5> c0 = 0; c0 <= 9; c0 += 1)
    for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1)
      for (ap_uint<4> c3 = 0; c3 <= 6; c3 += 1) {
        ...
        for (int c4 = 0; c4 <= min(79, -80 * c3 + 511); c4 += 1) {
          // io_L1
          for (int c5 = 0; c5 <= min(69, -70 * c0 + 639); c5 += 1)
            for (ap_uint<3> c6 = 0; c6 <= 2; c6 += 1)
              ...
              #pragma HLS PIPELINE II=1
                // access_coalesce
                {
                  w_t1 in_data;
                  w_t1 out_data;
                  in_data = w[322560*c0 + 80*c3 + c4 + 4608*c5 + 1536*c6 + 512*c7];
                  out_data = in_data;
                ...
                #pragma HLS PIPELINE II=1
                  {
                    w_t1 in_data;
                    w_t1 out_data;
                    in_data = local_w[c12 + 5*c5][c8][c9][0];
                    out_data = in_data;
                    fifo_w_local_out.write(out_data);
                  }
                }
              ...
              for (ap_uint<4> c7 = 0; c7 <= 6; c7 += 1) {
                if (p0 == 0 && c3 == 0) {
                  ...
                  for (ap_uint<4> c8 = 0; c8 <= 7; c8 += 1) {
                    // latency
                    for (int c9 = 0; c9 <= min(4, -5 * c6 + 16); c9 += 1) {
                      // latency
                      for (ap_uint<4> c10 = 0; c10 <= 4; c10 += 1) {
                      #pragma HLS PIPELINE II=1
                        local_cout[5*c6 + c9][8*c7 + c8][c10 + 5*c5] = 0;
                      }
                    }
                  }
                }
                        ...
                        #pragma HLS PIPELINE II=1
                          {
                            ...
                            if (p0 + 80 * c3 >= 1 && c8 == 0 && c9 == 0)
                              local_cout[c11 + 5*c6][c10 + 8*c7][c12 + 5*c5] = fifo_cout_1_in.read();
                            local_w[0][0][0][0] = fifo_w_in.read();
                            local_cout[c11 + 5*c6][c10 + 8*c7][c12 + 5*c5] = (local_cout[c11 + 5*c6][c10 + 8*c7][c12 + 5*c5] + (local_cin[0][0][0] * local_w[0][0][0][0]));
                            if (p0 == 31 && c3 == 6 && c8 == 2 && c9 == 2) {
                              fifo_cout_drain_out.write(local_cout[c11 + 5*c6][c10 + 8*c7][c12 + 5*c5]);
                            } else if (p0 + 80 * c3 <= 510 && c8 == 2 && c9 == 2) {
                              fifo_cout_1_out.write(local_cout[c11 + 5*c6][c10 + 8*c7][c12 + 5*c5]);
                            }
                          }
                        }
                      }
            ...
            #pragma HLS PIPELINE II=1
              {
                ...
                int split_idx = (c12 + 5*c5) % 2;
                out_data = local_cout_1[c11 + 5*c6][c10 + 8*c7][(5 * c5 + c12) / 2];
                for (ap_uint<2> n = 0; n < 2; n++) {
                #pragma HLS UNROLL
                ...
                out_data = (data_split[1], data_split[0]);                local_cout_1[c11 + 5*c6][c10 + 8*c7][(5 * c5 + c12) / 2] = out_data;
              }
            }
          }
        }
...
#pragma HLS INLINE OFF
  ...
  // io_L2
  for (int c4 = 0; c4 <= min(16, -17 * c1 + 55); c4 += 1)
    for (ap_uint<7> c5 = 0; c5 <= 55; c5 += 1) {
      // access_coalesce
      for (int c6 = 0; c6 <= min(34, -35 * c0 + 319); c6 += 1) {
      #pragma HLS PIPELINE II=1
        {
          cout_t2 in_data;
          cout_t2 out_data;
          ...
          out_data = in_data;
          cout[35*c0 + 304640*c1 + 17920*c4 + 320*c5 + c6] = out_data;
        }
      }
    }
}
...
/* Module Definition */
void cout_1_IO_L2_out_boundary(cout_t2 *cout, hls::stream<float> &fifo_cout_1_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  cout_t2 local_cout_1_ping[17][56][35];
  #pragma HLS RESOURCE variable=local_cout_1_ping core=RAM_2P_BRAM
            ...
            #pragma HLS PIPELINE II=1
              {
                ...
                int split_idx = (c12 + 5*c5) % 2;
                out_data = local_cout[c11 + 5*c6][c10 + 8*c7][(5 * c5 + c12) / 2];
                for (ap_uint<2> n = 0; n < 2; n++) {
                #pragma HLS UNROLL
                  data_split[n] = out_data(31, 0);
                  out_data = out_data >> 32;
                ...
                u.ut = in_data;
                data_split[split_idx] = ap_uint<32>(u.ui);
                out_data = (data_split[1], data_split[0]);                local_cout[c11 + 5*c6][c10 + 8*c7][(5 * c5 + c12) / 2] = out_data;
              }
            }
          }
        }
...
#pragma HLS INLINE
  ...
  // io_L1
  if (p0 == 31) {
    for (int c5 = 0; c5 <= min(16, -17 * c1 + 55); c5 += 1)
      for (ap_uint<7> c6 = 0; c6 <= 55; c6 += 1) {
        // access_coalesce
        for (int c7 = 0; c7 <= min(34, -35 * c0 + 319); c7 += 1) {
        #pragma HLS PIPELINE II=1
          {
            cout_t2 in_data;
            cout_t2 out_data;
...
/* Module Definition */
void cout_drain_IO_L1_out(int idx, hls::stream<cout_t2> &fifo_cout_drain_in, hls::stream<cout_t2> &fifo_cout_drain_out, hls::stream<float> &fifo_cout_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  cout_t2 local_cout[17][56][35];
  #pragma HLS RESOURCE variable=local_cout core=RAM_2P_BRAM
  /* Variable Declaration */
...
/* Module Definition */
void cout_drain_IO_L1_out_boundary(int idx, hls::stream<cout_t2> &fifo_cout_drain_out, hls::stream<float> &fifo_cout_drain_local_in) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx; // module id
  cout_t2 local_cout[17][56][35];
...
/* Module Definition */
void cout_drain_IO_L2_out(cout_t2 *cout, hls::stream<cout_t2> &fifo_cout_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
          ...
          #pragma HLS PIPELINE II=1
            {
              ...
              in_data = fifo_cout_drain_local_in.read();
              out_data = in_data;
              cout[35*c0 + 304640*c1 + 17920*c5 + 320*c6 + c7] = out_data;
            }
          }
        }
    }
...
#pragma HLS DATAFLOW
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_0;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_1;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_2;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_3;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_4;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_5;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_6;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_7;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_8;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_9;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_10;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_11;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_12;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_13;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_14;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_15;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_16;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_17;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_18;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_19;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_20;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_21;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_22;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_23;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_24;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_25;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_26;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_27;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_28;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_29;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_30;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_31;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_32;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_33;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_34;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_35;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_36;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_37;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_38;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_39;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_40;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_41;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_42;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_43;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_44;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_45;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_46;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_47;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_48;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_49;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_50;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_51;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_52;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_53;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_54;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_55;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_56;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_57;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_58;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_59;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_60;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_61;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_62;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_63;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_64;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_65;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_66;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_67;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_68;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_69;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_70;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_71;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_72;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_73;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_74;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_75;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_76;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_77;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_78;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_79;
  ...
  /* cout_drain_IO_L1_out fifo */ hls::stream<cout_t2> fifo_cout_drain_cout_drain_IO_L1_out_80;
