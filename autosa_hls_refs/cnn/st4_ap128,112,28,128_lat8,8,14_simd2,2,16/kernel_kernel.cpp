// AutoSA Command:
// /workspaces/mlir-systolic/third_party/AutoSA/autosa /workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/cnn/kernel.c --config=/workspaces/mlir-systolic/third_party/AutoSA/autosa_config/autosa_config.json --target=autosa_hls_c --output-dir=/workspaces/mlir-systolic/third_party/AutoSA/autosa.tmp/output --host-serialize --simd-info=/workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/cnn/simd_info.json --sa-sizes={kernel[]->space_time[4];kernel[]->array_part[128,112,28,128];kernel[]->latency[8,8,14];kernel[]->simd[2,2,16]}
...
void cin_IO_L2_in_intra_trans(int idx, int c0, int c2, int c3, cin_t16 local_cin[10][30][8], hls::stream<cin_t16> &fifo_cin_local_out, bool intra_trans_en);
void cin_IO_L2_in_inter_trans(int idx, int c0, int c2, int c3, cin_t16 local_cin[10][30][8], hls::stream<cin_t16> &fifo_cin_in, hls::stream<cin_t16> &fifo_cin_out, bool inter_trans_en);
void cin_IO_L2_in_inter_trans_boundary(int idx, int c0, int c2, int c3, cin_t16 local_cin[10][30][8], hls::stream<cin_t16> &fifo_cin_in, bool inter_trans_en);
void w_IO_L2_in_intra_trans(int idx, int c0, int c2, int c3, w_t16 local_w[8][3][3][8], hls::stream<w_t16> &fifo_w_local_out, bool intra_trans_en);
void w_IO_L2_in_inter_trans(int idx, int c0, int c2, int c3, w_t16 local_w[8][3][3][8], hls::stream<w_t16> &fifo_w_in, hls::stream<w_t16> &fifo_w_out, bool inter_trans_en);
void w_IO_L2_in_inter_trans_boundary(int idx, int c0, int c2, int c3, w_t16 local_w[8][3][3][8], hls::stream<w_t16> &fifo_w_in, bool inter_trans_en);
void PE_wrapper(int idx, int idy, hls::stream<cin_t16> &fifo_cin_in, hls::stream<cin_t16> &fifo_cin_out, hls::stream<float> &fifo_cout_drain_out, hls::stream<w_t16> &fifo_w_in, hls::stream<w_t16> &fifo_w_out);
void cout_drain_IO_L1_out_intra_trans(int idx, int idy, int c0, int c2, cout_t4 local_cout[8][28][2], hls::stream<float> &fifo_cout_drain_local_in);
void cout_drain_IO_L1_out_inter_trans(int idx, int idy, int c0, int c2, cout_t4 local_cout[8][28][2], hls::stream<cout_t4> &fifo_cout_drain_in, hls::stream<cout_t4> &fifo_cout_drain_out);
void cout_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, int c0, int c2, cout_t4 local_cout[8][28][2], hls::stream<cout_t4> &fifo_cout_drain_out);
    ...
    for (ap_uint<2> c2 = 0; c2 <= 1; c2 += 1)
      for (ap_uint<3> c3 = 0; c3 <= 3; c3 += 1) {
        ...
        for (ap_uint<4> c4 = 0; c4 <= 6; c4 += 1) {
          // io_L2
          for (ap_uint<5> c5 = 0; c5 <= 9; c5 += 1)
            for (ap_uint<6> c6 = 0; c6 <= 29; c6 += 1) {
              // access_coalesce
              // access_serialize
            ...
            for (ap_uint<4> c11 = 0; c11 <= 7; c11 += 1) {
              ...
              #pragma HLS PIPELINE II=1
                // simd
                {
                  cin_t16 in_data;
                  cin_t16 out_data;
                  in_data = local_cin[c11 + c8][c10 + 14*c6 + c9][c7];
                  out_data = in_data;
                  fifo_cin_local_out.write(out_data);
                }
              }
...
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  cin_t16 local_cin_ping[10][30][8];
  #pragma HLS RESOURCE variable=local_cin_ping core=RAM_1P_BRAM
  cin_t16 local_cin_pong[10][30][8];
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<cin_t16> &fifo_cin_in, hls::stream<cin_t16> &fifo_cin_out, hls::stream<float> &fifo_cout_drain_out, hls::stream<w_t16> &fifo_w_in, hls::stream<w_t16> &fifo_w_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
                    ...
                    #pragma HLS PIPELINE II=1
                      {
                        ...
                        #pragma HLS UNROLL
                          local_cout[c11][c10 + 14*c6][c12] = (local_cout[c11][c10 + 14*c6][c12] + (local_cin[0][0][c13] * local_w[0][0][0][c13]));
                        }
                        {
                          w_t16 fifo_data;
                        ...
                        if (c3 == 3 && c7 == 7 && c8 == 2 && c9 == 2)
                          fifo_cout_drain_out.write(local_cout[c11][c10 + 14*c6][c12]);
                        {
                          cin_t16 fifo_data;
                          union {unsigned int ui; float ut;} u15, u14, u13, u12, u11, u10, u9, u8, u7, u6, u5, u4, u3, u2, u1, u0;
      ...
      for (ap_uint<4> c11 = 0; c11 <= 7; c11 += 1) {
        ...
        #pragma HLS PIPELINE II=1
          // simd
          {
            ...
            int split_idx = (c12) % 4;
            out_data = local_cout[c11][c10 + 14*c6][c12 / 4];
            ...
            out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);            local_cout[c11][c10 + 14*c6][c12 / 4] = out_data;
          }
        }
      }
    }
...
#pragma HLS DATAFLOW
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_0_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_1_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_2_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_3_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_4_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_5_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_6_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_7_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_8_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_9_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_10_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_11_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_12_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_13_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_14_7;
  ...
  /* PE fifo */ hls::stream<w_t16> fifo_w_PE_15_7;
