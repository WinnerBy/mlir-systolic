...
//  data_t cout_golden[O][R][C];
 ...
 
  {
    ...
    std::vector<float, aligned_allocator<float>> dev_cin(33030144);
    ...
    std::vector<float, aligned_allocator<float>> dev_w(165150720);
