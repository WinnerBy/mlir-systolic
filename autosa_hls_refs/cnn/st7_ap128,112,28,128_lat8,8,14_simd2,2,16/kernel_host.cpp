...
//  data_t cout_golden[O][R][C];
 ...
 
  {
    ...
    std::vector<float, aligned_allocator<float>> dev_cin(57702400);
    ...
    std::vector<float, aligned_allocator<float>> dev_w(20643840);
