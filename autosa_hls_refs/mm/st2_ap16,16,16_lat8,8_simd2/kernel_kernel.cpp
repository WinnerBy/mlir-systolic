...
void A_IO_L1_in_intra_trans(int idx, int c0, int c1, int c2, A_t2 local_A[16][1], hls::stream<A_t2> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L1_in_inter_trans(int idx, int c0, int c1, int c2, A_t2 local_A[16][1], hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, bool inter_trans_en);
void A_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c2, A_t2 local_A[16][1], hls::stream<A_t2> &fifo_A_in, bool inter_trans_en);
void A_IO_L1_in_wrapper(int idx, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<A_t2> &fifo_A_local_out);
void A_IO_L1_in_boundary_wrapper(int idx, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_local_out);
void B_IO_L1_in_intra_trans(int idx, int c0, int c1, int c2, B_t2 local_B[16][1], hls::stream<B_t2> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L1_in_inter_trans(int idx, int c0, int c1, int c2, B_t2 local_B[16][1], hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, bool inter_trans_en);
void B_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c2, B_t2 local_B[16][1], hls::stream<B_t2> &fifo_B_in, bool inter_trans_en);
void B_IO_L1_in_wrapper(int idx, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<B_t2> &fifo_B_local_out);
void B_IO_L1_in_boundary_wrapper(int idx, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_local_out);
void PE_wrapper(int idx, hls::stream<A_t2> &fifo_A_in, hls::stream<B_t2> &fifo_B_in, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_C_out);
void C_IO_L2_out_intra_trans(int c0, int c1, C_t16 local_C[16][1], hls::stream<float> &fifo_C_local_in, bool intra_trans_en);
void C_IO_L2_out_inter_trans_boundary(int c0, int c1, C_t16 local_C[16][1], hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);

/* Module Definition */
void A_IO_L2_in(hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_local_out) {
...
/* Module Definition */
void A_IO_L2_in_serialize(A_t16 *A, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L1_in(int idx, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
...
/* Module Definition */
void A_IO_L1_in_boundary(int idx, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t2 local_A_ping[16][1];
...
/* Module Definition */
void B_IO_L2_in(hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L2_in_serialize(B_t16 *B, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L1_in(int idx, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
...
/* Module Definition */
void B_IO_L1_in_boundary(int idx, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t2 local_B_ping[16][1];
...
/* Module Definition */
void PE(int idx, hls::stream<A_t2> &fifo_A_in, hls::stream<B_t2> &fifo_B_in, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_C_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t1 local_A[1][2];
        ...
        for (ap_uint<4> c6 = 0; c6 <= 7; c6 += 1) {
          ...
          #pragma HLS PIPELINE II=1
            // simd
            {
              ...
              out_data = local_C[8*c4 + c7][(8 * c5 + c6) / 16];
              ...
              /* Local Reduction */
              out_data = (data_split[15], data_split[14], data_split[13], data_split[12], data_split[11], data_split[10], data_split[9], data_split[8], data_split[7], data_split[6], data_split[5], data_split[4], data_split[3], data_split[2], data_split[1], data_split[0]);              local_C[8*c4 + c7][(8 * c5 + c6) / 16] = out_data;
            }
          }
        }
      }
...
#pragma HLS DATAFLOW
  ...
  /* FIFO Declaration */
  /* A_IO_L2_in_serialize fifo */ hls::stream<A_t2> fifo_A_A_IO_L2_in_serialize;
  #pragma HLS STREAM variable=fifo_A_A_IO_L2_in_serialize depth=2
  /* B_IO_L2_in_serialize fifo */ hls::stream<B_t2> fifo_B_B_IO_L2_in_serialize;
