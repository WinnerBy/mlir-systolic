...
void A_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, A_t2 local_A[16][1], hls::stream<A_t2> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, A_t2 local_A[16][1], hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, bool inter_trans_en);
void A_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, A_t2 local_A[16][1], hls::stream<A_t2> &fifo_A_in, bool inter_trans_en);
void B_IO_L1_in_intra_trans(int idx, int idy, int c0, int c1, int c2, B_t2 local_B[8][1], hls::stream<B_t2> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L1_in_inter_trans(int idx, int idy, int c0, int c1, int c2, B_t2 local_B[8][1], hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, bool inter_trans_en);
void B_IO_L1_in_inter_trans_boundary(int idx, int idy, int c0, int c1, int c2, B_t2 local_B[8][1], hls::stream<B_t2> &fifo_B_in, bool inter_trans_en);
void B_IO_L1_in_wrapper(int idx, int idy, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<B_t2> &fifo_B_local_out);
void B_IO_L1_in_boundary_wrapper(int idx, int idy, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_local_out);
void PE_wrapper(int idx, int idy, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<B_t2> &fifo_B_in, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_C_out);
void C_IO_L2_out_intra_trans(int idx, int c0, int c1, C_t8 local_C[16][1], hls::stream<float> &fifo_C_local_in, bool intra_trans_en);
void C_IO_L2_out_inter_trans(int idx, int c0, int c1, C_t8 local_C[16][1], hls::stream<C_t8> &fifo_C_in, hls::stream<C_t8> &fifo_C_out, bool inter_trans_en);
void C_IO_L2_out_inter_trans_boundary(int idx, int c0, int c1, C_t8 local_C[16][1], hls::stream<C_t8> &fifo_C_out, bool inter_trans_en);

/* Module Definition */
void A_IO_L3_in(hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_local_out) {
...
/* Module Definition */
void A_IO_L3_in_serialize(A_t16 *A, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L1_in(int idx, int idy, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  B_t2 local_B_ping[8][1];
  #pragma HLS RESOURCE variable=local_B_ping core=RAM_1P_BRAM
  B_t2 local_B_pong[8][1];
...
/* Module Definition */
void B_IO_L1_in_boundary(int idx, int idy, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  B_t2 local_B_ping[8][1];
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<B_t2> &fifo_B_in, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_C_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t1 local_A[1][2];
      ...
      for (ap_uint<4> c6 = 0; c6 <= 7; c6 += 1) {
        ...
        #pragma HLS PIPELINE II=1
          // simd
          {
            ...
            /* Local Reduction */
            out_data = (data_split[7], data_split[6], data_split[5], data_split[4], data_split[3], data_split[2], data_split[1], data_split[0]);            local_C[8*c5 + c6][c7 / 8] = out_data;
          }
        }
      }
    }
...
/* Module Definition */
void C_IO_L2_out(int idx, hls::stream<C_t8> &fifo_C_in, hls::stream<C_t8> &fifo_C_out, hls::stream<float> &fifo_C_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  C_t8 local_C_ping[16][1];
  #pragma HLS RESOURCE variable=local_C_ping core=RAM_2P_BRAM
  C_t8 local_C_pong[16][1];
...
/* Module Definition */
void C_IO_L2_out_boundary(int idx, hls::stream<C_t8> &fifo_C_out, hls::stream<float> &fifo_C_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  C_t8 local_C_ping[16][1];
...
/* Module Definition */
void C_IO_L3_out(hls::stream<C_t8> &fifo_C_out, hls::stream<C_t8> &fifo_C_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void C_IO_L3_out_serialize(C_t16 *C, hls::stream<C_t8> &fifo_C_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
#pragma HLS DATAFLOW
  ...
  /* FIFO Declaration */
  /* A_IO_L3_in_serialize fifo */ hls::stream<A_t2> fifo_A_A_IO_L3_in_serialize;
  ...
  /* C_IO_L3_out_serialize fifo */ hls::stream<C_t8> fifo_C_C_IO_L3_out_serialize;
