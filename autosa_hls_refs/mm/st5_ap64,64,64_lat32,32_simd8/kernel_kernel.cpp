...
void A_IO_L2_in_intra_trans(int idx, A_t8 local_A[64][1], hls::stream<A_t8> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L2_in_inter_trans(int idx, A_t8 local_A[64][1], hls::stream<A_t8> &fifo_A_in, hls::stream<A_t8> &fifo_A_out, bool inter_trans_en);
void A_IO_L2_in_inter_trans_boundary(int idx, A_t8 local_A[64][1], hls::stream<A_t8> &fifo_A_in, bool inter_trans_en);
void B_IO_L1_in_intra_trans(int idx, int idy, B_t8 local_B[32][1], hls::stream<B_t8> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L1_in_inter_trans(int idx, int idy, B_t8 local_B[32][1], hls::stream<B_t8> &fifo_B_in, hls::stream<B_t8> &fifo_B_out, bool inter_trans_en);
void B_IO_L1_in_inter_trans_boundary(int idx, int idy, B_t8 local_B[32][1], hls::stream<B_t8> &fifo_B_in, bool inter_trans_en);
void B_IO_L1_in_wrapper(int idx, int idy, hls::stream<B_t8> &fifo_B_in, hls::stream<B_t8> &fifo_B_out, hls::stream<B_t8> &fifo_B_local_out);
void B_IO_L1_in_boundary_wrapper(int idx, int idy, hls::stream<B_t8> &fifo_B_in, hls::stream<B_t8> &fifo_B_local_out);
void PE_wrapper(int idx, int idy, hls::stream<A_t8> &fifo_A_in, hls::stream<A_t8> &fifo_A_out, hls::stream<B_t8> &fifo_B_in, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_C_out);
void C_IO_L2_out_intra_trans(int idx, C_t16 local_C[64][2], hls::stream<float> &fifo_C_local_in, bool intra_trans_en);
void C_IO_L2_out_inter_trans(int idx, C_t16 local_C[64][2], hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
void C_IO_L2_out_inter_trans_boundary(int idx, C_t16 local_C[64][2], hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
...
/* Module Definition */
void B_IO_L1_in(int idx, int idy, hls::stream<B_t8> &fifo_B_in, hls::stream<B_t8> &fifo_B_out, hls::stream<B_t8> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
...
/* Module Definition */
void B_IO_L1_in_boundary(int idx, int idy, hls::stream<B_t8> &fifo_B_in, hls::stream<B_t8> &fifo_B_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  B_t8 local_B_ping[32][1];
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<A_t8> &fifo_A_in, hls::stream<A_t8> &fifo_A_out, hls::stream<B_t8> &fifo_B_in, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_C_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t1 local_A[1][8];
    ...
    for (ap_uint<6> c6 = 0; c6 <= 31; c6 += 1) {
      ...
      #pragma HLS PIPELINE II=1
        // simd
        {
          ...
          int split_idx = (c7) % 16;
          out_data = local_C[32*c5 + c6][c7 / 16];
          ...
          /* Local Reduction */
          out_data = (data_split[15], data_split[14], data_split[13], data_split[12], data_split[11], data_split[10], data_split[9], data_split[8], data_split[7], data_split[6], data_split[5], data_split[4], data_split[3], data_split[2], data_split[1], data_split[0]);          local_C[32*c5 + c6][c7 / 16] = out_data;
        }
      }
    }
  }
