...
void A_IO_L1_in_intra_trans(int idx, int idy, int c0, int c1, int c2, A_t4 local_A[16][1], hls::stream<A_t4> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L1_in_inter_trans(int idx, int idy, int c0, int c1, int c2, A_t4 local_A[16][1], hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_out, bool inter_trans_en);
void A_IO_L1_in_inter_trans_boundary(int idx, int idy, int c0, int c1, int c2, A_t4 local_A[16][1], hls::stream<A_t4> &fifo_A_in, bool inter_trans_en);
...
void B_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, B_t4 local_B[32][1], hls::stream<B_t4> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, B_t4 local_B[32][1], hls::stream<B_t4> &fifo_B_in, hls::stream<B_t4> &fifo_B_out, bool inter_trans_en);
void B_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, B_t4 local_B[32][1], hls::stream<B_t4> &fifo_B_in, bool inter_trans_en);
void PE_wrapper(int idx, int idy, hls::stream<A_t4> &fifo_A_in, hls::stream<B_t4> &fifo_B_in, hls::stream<B_t4> &fifo_B_out, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_C_out);
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<A_t4> &fifo_A_in, hls::stream<B_t4> &fifo_B_in, hls::stream<B_t4> &fifo_B_out, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_C_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t1 local_A[1][4];
...
/* Module Definition */
void B_PE_dummy_in(int idx, int idy, hls::stream<B_t4> &fifo_B_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
#pragma HLS DATAFLOW
  ...
  /* PE fifo */ hls::stream<B_t4> fifo_B_PE_2_2;
  ...
  /* PE fifo */ hls::stream<B_t4> fifo_B_PE_2_3;
  ...
  /* PE fifo */ hls::stream<B_t4> fifo_B_PE_2_4;
  ...
  /* PE fifo */ hls::stream<B_t4> fifo_B_PE_2_5;
  ...
  /* PE fifo */ hls::stream<B_t4> fifo_B_PE_2_6;
  ...
  /* PE fifo */ hls::stream<B_t4> fifo_B_PE_2_7;
