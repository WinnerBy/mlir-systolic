...
void A_IO_L1_in_intra_trans(int idx, int idy, int c0, int c1, int c2, int c3, A_t4 local_A[4][64][32], hls::stream<A_t4> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L1_in_inter_trans(int idx, int idy, int c0, int c1, int c2, int c3, A_t4 local_A[4][64][32], hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_out, bool inter_trans_en);
void A_IO_L1_in_inter_trans_boundary(int idx, int idy, int c0, int c1, int c2, int c3, A_t4 local_A[4][64][32], hls::stream<A_t4> &fifo_A_in, bool inter_trans_en);
void A_IO_L1_in_wrapper(int idx, int idy, hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_out, hls::stream<A_t4> &fifo_A_local_out);
void A_IO_L1_in_boundary_wrapper(int idx, int idy, hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_local_out);
void B_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, int c3, B_t16 local_B[64][4], hls::stream<float> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, int c3, B_t16 local_B[64][4], hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_out, bool inter_trans_en);
void B_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, int c3, B_t16 local_B[64][4], hls::stream<B_t16> &fifo_B_in, bool inter_trans_en);
void C_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, C_t16 local_C[8][8], hls::stream<C_t4> &fifo_C_local_out, bool intra_trans_en);
void C_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, C_t16 local_C[8][8], hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
void C_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, C_t16 local_C[8][8], hls::stream<C_t16> &fifo_C_in, bool inter_trans_en);
void PE_wrapper(int idx, int idy, hls::stream<A_t4> &fifo_A_in, hls::stream<float> &fifo_B_in, hls::stream<float> &fifo_B_out, hls::stream<C_t4> &fifo_C_in, hls::stream<C_t4> &fifo_C_out, hls::stream<float> &fifo_D_drain_out);
void D_drain_IO_L1_out_intra_trans(int idx, int idy, int c0, int c1, int c2, D_t4 local_D[4][64][2], hls::stream<float> &fifo_D_drain_local_in);
void D_drain_IO_L1_out_inter_trans(int idx, int idy, int c0, int c1, int c2, D_t4 local_D[4][64][2], hls::stream<D_t4> &fifo_D_drain_in, hls::stream<D_t4> &fifo_D_drain_out);
void D_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, int c0, int c1, int c2, D_t4 local_D[4][64][2], hls::stream<D_t4> &fifo_D_drain_out);
...
/* Module Definition */
void A_IO_L1_in(int idx, int idy, hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_out, hls::stream<A_t4> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t4 local_A_ping[4][64][32];
  #pragma HLS RESOURCE variable=local_A_ping core=RAM_1P_BRAM
  A_t4 local_A_pong[4][64][32];
...
/* Module Definition */
void A_IO_L1_in_boundary(int idx, int idy, hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t4 local_A_ping[4][64][32];
          ...
          for (ap_uint<4> c10 = 0; c10 <= 7; c10 += 1) {
            ...
            #pragma HLS PIPELINE II=1
              // simd
              {
                B_t16 in_data;
                B_t1 out_data;
                in_data = local_B[c7][(8 * c6 + c9) / 16];
                for (ap_uint<5> n = 0; n < 16; n++) {
                #pragma HLS UNROLL
                  data_split[n] = in_data(31, 0);
                  in_data = in_data >> 32;
                }
                int split_idx = (8*c6 + c9) % 16;
...
/* Module Definition */
void C_IO_L2_in(int idx, hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, hls::stream<C_t4> &fifo_C_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  C_t16 local_C_ping[8][8];
  #pragma HLS RESOURCE variable=local_C_ping core=RAM_2P_BRAM
  C_t16 local_C_pong[8][8];
...
/* Module Definition */
void C_IO_L2_in_boundary(int idx, hls::stream<C_t16> &fifo_C_in, hls::stream<C_t4> &fifo_C_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  C_t16 local_C_ping[8][8];
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<A_t4> &fifo_A_in, hls::stream<float> &fifo_B_in, hls::stream<float> &fifo_B_out, hls::stream<C_t4> &fifo_C_in, hls::stream<C_t4> &fifo_C_out, hls::stream<float> &fifo_D_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t1 local_A[1][1][4];
                    ...
                    #pragma HLS PIPELINE II=1
                      {
                        ...
                        #pragma HLS UNROLL
                          local_D[c11][8*c6 + c9][c10] = (local_D[c11][8*c6 + c9][c10] + ((local_A[0][0][c12] * local_B[0][0]) * local_C[0][c12]));
                        }
                        if (c3 == 1 && c7 == 63 && c8 == 31)
                          fifo_D_drain_out.write(local_D[c11][8*c6 + c9][c10]);
                        {
                          C_t4 fifo_data;
...
/* Module Definition */
void C_PE_dummy_in(int idx, int idy, hls::stream<C_t4> &fifo_C_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
      ...
      for (ap_uint<4> c10 = 0; c10 <= 7; c10 += 1) {
        ...
        #pragma HLS PIPELINE II=1
          // simd
          {
            ...
            int split_idx = (c10) % 4;
            out_data = local_D[c11][8*c6 + c9][c10 / 4];
            for (ap_uint<3> n = 0; n < 4; n++) {
            #pragma HLS UNROLL
            ...
            out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);            local_D[c11][8*c6 + c9][c10 / 4] = out_data;
          }
        }
      }
    }
...
#pragma HLS DATAFLOW
  ...
  /* PE fifo */ hls::stream<C_t4> fifo_C_PE_16_0;
  ...
  /* PE fifo */ hls::stream<C_t4> fifo_C_PE_16_1;
  ...
  /* PE fifo */ hls::stream<C_t4> fifo_C_PE_16_2;
  ...
  /* PE fifo */ hls::stream<C_t4> fifo_C_PE_16_3;
  ...
  /* PE fifo */ hls::stream<C_t4> fifo_C_PE_16_4;
  ...
  /* PE fifo */ hls::stream<C_t4> fifo_C_PE_16_5;
  ...
  /* PE fifo */ hls::stream<C_t4> fifo_C_PE_16_6;
  ...
  /* PE fifo */ hls::stream<C_t4> fifo_C_PE_16_7;
