// AutoSA Command:
// /workspaces/mlir-systolic/third_party/AutoSA/autosa /workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/ttmc/kernel.c --config=/workspaces/mlir-systolic/third_party/AutoSA/autosa_config/autosa_config.json --target=autosa_hls_c --output-dir=/workspaces/mlir-systolic/third_party/AutoSA/autosa.tmp/output --host-serialize --simd-info=/workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/ttmc/simd_info.json --sa-sizes={kernel[]->space_time[4];kernel[]->array_part[16,16,16,16];kernel[]->latency[1,2,2];kernel[]->simd[1,1]}
...
void A_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, int c3, A_t16 local_A[1][16][8], hls::stream<float> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, int c3, A_t16 local_A[1][16][8], hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, bool inter_trans_en);
void A_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, int c3, A_t16 local_A[1][16][8], hls::stream<A_t16> &fifo_A_in, bool inter_trans_en);
void B_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, int c3, B_t2 local_B[16][1], hls::stream<float> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, int c3, B_t2 local_B[16][1], hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, bool inter_trans_en);
void B_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, int c3, B_t2 local_B[16][1], hls::stream<B_t2> &fifo_B_in, bool inter_trans_en);
void C_IO_L2_in_intra_trans(int idx, int c0, int c1, int c2, C_t16 local_C[16][8], hls::stream<float> &fifo_C_local_out, bool intra_trans_en);
void C_IO_L2_in_inter_trans(int idx, int c0, int c1, int c2, C_t16 local_C[16][8], hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
void C_IO_L2_in_inter_trans_boundary(int idx, int c0, int c1, int c2, C_t16 local_C[16][8], hls::stream<C_t16> &fifo_C_in, bool inter_trans_en);
void PE_wrapper(int idx, int idy, hls::stream<float> &fifo_A_in, hls::stream<float> &fifo_A_out, hls::stream<float> &fifo_B_in, hls::stream<float> &fifo_B_out, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_C_out, hls::stream<float> &fifo_D_drain_out);
void D_drain_IO_L1_out_intra_trans(int idx, int idy, int c0, int c1, int c2, D_t4 local_D[1][2][4], hls::stream<float> &fifo_D_drain_local_in);
void D_drain_IO_L1_out_inter_trans(int idx, int idy, int c0, int c1, int c2, D_t4 local_D[1][2][4], hls::stream<D_t4> &fifo_D_drain_in, hls::stream<D_t4> &fifo_D_drain_out);
void D_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, int c0, int c1, int c2, D_t4 local_D[1][2][4], hls::stream<D_t4> &fifo_D_drain_out);
...
/* Module Definition */
void B_IO_L2_in(int idx, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<float> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t2 local_B_ping[16][1];
  #pragma HLS RESOURCE variable=local_B_ping core=RAM_2P_BRAM
  B_t2 local_B_pong[16][1];
...
/* Module Definition */
void B_IO_L2_in_boundary(int idx, hls::stream<B_t2> &fifo_B_in, hls::stream<float> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t2 local_B_ping[16][1];
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<float> &fifo_A_in, hls::stream<float> &fifo_A_out, hls::stream<float> &fifo_B_in, hls::stream<float> &fifo_B_out, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_C_out, hls::stream<float> &fifo_D_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
                  ...
                  #pragma HLS PIPELINE II=1
                    {
                      ...
                      local_D[0][c10][2*c6 + c9] = (local_D[0][c10][2*c6 + c9] + ((local_A[0][0][0] * local_B[0][0]) * local_C[0][0]));
                      if (c3 == 7 && c7 == 15 && c8 == 127)
                        fifo_D_drain_out.write(local_D[0][c10][2*c6 + c9]);
                      fifo_C_out.write(local_C[0][0]);
                      fifo_B_out.write(local_B[0][0]);
                      fifo_A_out.write(local_A[0][0][0]);
                    }
                  }
                }
              }
      ...
      #pragma HLS PIPELINE II=1
        {
          ...
          int split_idx = (2*c6 + c9) % 4;
          out_data = local_D[0][c10][(2 * c6 + c9) / 4];
          ...
          out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);          local_D[0][c10][(2 * c6 + c9) / 4] = out_data;
        }
      }
    }
  }
