...
void A_IO_L1_in_intra_trans(int idx, int c0, int c1, int c2, int c3, A_t4 local_A[16][1][32], hls::stream<float> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L1_in_inter_trans(int idx, int c0, int c1, int c2, int c3, A_t4 local_A[16][1][32], hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_out, bool inter_trans_en);
void A_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c2, int c3, A_t4 local_A[16][1][32], hls::stream<A_t4> &fifo_A_in, bool inter_trans_en);
void A_IO_L1_in_wrapper(int idx, hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_out, hls::stream<float> &fifo_A_local_out);
void A_IO_L1_in_boundary_wrapper(int idx, hls::stream<A_t4> &fifo_A_in, hls::stream<float> &fifo_A_local_out);
void B_IO_L1_in_intra_trans(int idx, int c0, int c1, int c2, int c3, B_t4 local_B[1][4], hls::stream<float> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L1_in_inter_trans(int idx, int c0, int c1, int c2, int c3, B_t4 local_B[1][4], hls::stream<B_t4> &fifo_B_in, hls::stream<B_t4> &fifo_B_out, bool inter_trans_en);
void B_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c2, int c3, B_t4 local_B[1][4], hls::stream<B_t4> &fifo_B_in, bool inter_trans_en);
...
void C_IO_L1_in_intra_trans(int idx, int c0, int c1, int c2, C_t4 local_C[16][32], hls::stream<float> &fifo_C_local_out, bool intra_trans_en);
void C_IO_L1_in_inter_trans(int idx, int c0, int c1, int c2, C_t4 local_C[16][32], hls::stream<C_t4> &fifo_C_in, hls::stream<C_t4> &fifo_C_out, bool inter_trans_en);
void C_IO_L1_in_inter_trans_boundary(int idx, int c0, int c1, int c2, C_t4 local_C[16][32], hls::stream<C_t4> &fifo_C_in, bool inter_trans_en);
void C_IO_L1_in_wrapper(int idx, hls::stream<C_t4> &fifo_C_in, hls::stream<C_t4> &fifo_C_out, hls::stream<float> &fifo_C_local_out);
void C_IO_L1_in_boundary_wrapper(int idx, hls::stream<C_t4> &fifo_C_in, hls::stream<float> &fifo_C_local_out);
void D_1_IO_L2_in_intra_trans(int c0, int c1, int c2, int c3, D_t16 *D, D_t16 local_D_1[16][16][1], hls::stream<float> &fifo_D_1_local_out, bool intra_trans_en);
void PE_wrapper(int idx, hls::stream<float> &fifo_A_in, hls::stream<float> &fifo_B_in, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_D_1_in, hls::stream<float> &fifo_D_1_out, hls::stream<float> &fifo_D_drain_out);
void D_1_IO_L2_out_intra_trans(int c0, int c1, int c2, int c3, D_t16 *D, D_t16 local_D_1[16][16][1], hls::stream<float> &fifo_D_1_local_in, bool intra_trans_en);
void D_1_IO_L2_out_inter_trans_boundary(int c0, int c1, int c2, D_t16 *D, D_t16 local_D_1[16][16][1], hls::stream<D_t16> &fifo_D_1_out, bool inter_trans_en);
void D_drain_IO_L1_out_intra_trans(int idx, int c0, int c1, int c2, D_t4 local_D[16][16][4], hls::stream<float> &fifo_D_drain_local_in);
void D_drain_IO_L1_out_inter_trans(int idx, int c0, int c1, int c2, D_t4 local_D[16][16][4], hls::stream<D_t4> &fifo_D_drain_in, hls::stream<D_t4> &fifo_D_drain_out);
void D_drain_IO_L1_out_inter_trans_boundary(int idx, int c0, int c1, int c2, D_t4 local_D[16][16][4], hls::stream<D_t4> &fifo_D_drain_out);
              ...
              #pragma HLS PIPELINE II=1
                {
                  ...
                  A_t4 out_data;
                  if (c7 % 4 == 0) {
                    in_data = A[(((16 * c0 + c5) * 128 + (16 * c3 + c4)) * 128 + 4 * c7) / 16];
                  ...
                  int split_idx = (65536*c0 + 512*c3 + 32*c4 + 4096*c5 + c7) % 4;
...
/* Module Definition */
void A_IO_L1_in(int idx, hls::stream<A_t4> &fifo_A_in, hls::stream<A_t4> &fifo_A_out, hls::stream<float> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t4 local_A_ping[16][1][32];
  #pragma HLS RESOURCE variable=local_A_ping core=RAM_2P_BRAM
  A_t4 local_A_pong[16][1][32];
...
/* Module Definition */
void A_IO_L1_in_boundary(int idx, hls::stream<A_t4> &fifo_A_in, hls::stream<float> &fifo_A_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t4 local_A_ping[16][1][32];
            ...
            #pragma HLS PIPELINE II=1
              {
                ...
                B_t4 out_data;
                if (c6 % 4 == 0) {
                  in_data = B[((16 * c3 + c4) * 128 + (16 * c1 + 4 * c6)) / 16];
                  for (ap_uint<3> n = 0; n < 4; n++) {
                  #pragma HLS UNROLL
                    data_split[n] = in_data(127, 0);
                    in_data = in_data >> 128;
                ...
                int split_idx = (4*c1 + 512*c3 + 32*c4 + c6) % 4;
                out_data = data_split[split_idx];
            ...
            #pragma HLS PIPELINE II=1
              {
                B_t4 in_data;
                B_t1 out_data;
                in_data = local_B[0][(2 * c6 + c10) / 4];
                for (ap_uint<3> n = 0; n < 4; n++) {
                #pragma HLS UNROLL
                  data_split[n] = in_data(31, 0);
                  in_data = in_data >> 32;
                }
                int split_idx = (c10 + 2*c6) % 4;
                union {unsigned int ui; float ut;} u;
                u.ui = (unsigned int)data_split[split_idx];
                out_data = u.ut;
                fifo_B_local_out.write(out_data);
            ...
            #pragma HLS PIPELINE II=1
              {
                ...
                C_t4 out_data;
                if (c6 % 4 == 0) {
                  in_data = C[((16 * c2 + c5) * 128 + 4 * c6) / 16];
                  for (ap_uint<3> n = 0; n < 4; n++) {
                  #pragma HLS UNROLL
                    data_split[n] = in_data(127, 0);
                    in_data = in_data >> 128;
                ...
                int split_idx = (512*c2 + 32*c5 + c6) % 4;
                out_data = data_split[split_idx];
...
/* Module Definition */
void C_IO_L1_in(int idx, hls::stream<C_t4> &fifo_C_in, hls::stream<C_t4> &fifo_C_out, hls::stream<float> &fifo_C_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  C_t4 local_C_ping[16][32];
  #pragma HLS RESOURCE variable=local_C_ping core=RAM_2P_BRAM
  C_t4 local_C_pong[16][32];
...
/* Module Definition */
void C_IO_L1_in_boundary(int idx, hls::stream<C_t4> &fifo_C_in, hls::stream<float> &fifo_C_local_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx; // module id
  C_t4 local_C_ping[16][32];
          ...
          #pragma HLS PIPELINE II=1
            {
              D_t16 in_data;
              D_t1 out_data;
              in_data = local_D_1[c5][c10 + 2*c6][(2 * c7 + c9) / 16];
              for (ap_uint<5> n = 0; n < 16; n++) {
              #pragma HLS UNROLL
                data_split[n] = in_data(31, 0);
                in_data = in_data >> 32;
              }
              int split_idx = (2*c7 + c9) % 16;
              union {unsigned int ui; float ut;} u;
              u.ui = (unsigned int)data_split[split_idx];
              out_data = u.ut;
...
/* Module Definition */
void PE(int idx, hls::stream<float> &fifo_A_in, hls::stream<float> &fifo_B_in, hls::stream<float> &fifo_C_in, hls::stream<float> &fifo_D_1_in, hls::stream<float> &fifo_D_1_out, hls::stream<float> &fifo_D_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t1 local_A[1][1][1];
                    ...
                    #pragma HLS PIPELINE II=1
                      {
                        ...
                        if (p0 + 16 * c3 >= 1 && c8 == 0)
                          local_D[c5][c10 + 2*c6][2*c7 + c9] = fifo_D_1_in.read();
                        local_D[c5][c10 + 2*c6][2*c7 + c9] = (local_D[c5][c10 + 2*c6][2*c7 + c9] + ((local_A[0][0][0] * local_B[0][0]) * local_C[0][0]));
                        if (p0 == 15 && c3 == 7 && c8 == 127) {
                          fifo_D_drain_out.write(local_D[c5][c10 + 2*c6][2*c7 + c9]);
                        } else if (p0 + 16 * c3 <= 126 && c8 == 127) {
                          fifo_D_1_out.write(local_D[c5][c10 + 2*c6][2*c7 + c9]);
                        }
                      }
                    }
                  }
          ...
          #pragma HLS PIPELINE II=1
            {
              ...
              int split_idx = (2*c7 + c9) % 16;
              out_data = local_D_1[c5][c10 + 2*c6][(2 * c7 + c9) / 16];
              for (ap_uint<5> n = 0; n < 16; n++) {
              #pragma HLS UNROLL
              ...
              out_data = (data_split[15], data_split[14], data_split[13], data_split[12], data_split[11], data_split[10], data_split[9], data_split[8], data_split[7], data_split[6], data_split[5], data_split[4], data_split[3], data_split[2], data_split[1], data_split[0]);              local_D_1[c5][c10 + 2*c6][(2 * c7 + c9) / 16] = out_data;
            }
          }
        }
      }
  ...
  for (ap_uint<5> c4 = 0; c4 <= 15; c4 += 1)
    ...
    #pragma HLS PIPELINE II=1
      // access_coalesce
      {
        D_t16 in_data;
        D_t16 out_data;
        in_data = local_D_1[c4][c5][0];
        out_data = in_data;
        D[16384*c0 + 128*c1 + c2 + 1024*c4 + 8*c5] = out_data;
      }
    }
}
/* Module Definition */
          ...
          #pragma HLS PIPELINE II=1
            {
              ...
              int split_idx = (2*c7 + c9) % 4;
              out_data = local_D[c5][c10 + 2*c6][(2 * c7 + c9) / 4];
              for (ap_uint<3> n = 0; n < 4; n++) {
              #pragma HLS UNROLL
                data_split[n] = out_data(31, 0);
                out_data = out_data >> 32;
              ...
              u.ut = in_data;
              data_split[split_idx] = ap_uint<32>(u.ui);
              out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);              local_D[c5][c10 + 2*c6][(2 * c7 + c9) / 4] = out_data;
            }
          }
        }
      }
            ...
            #pragma HLS PIPELINE II=1
              {
                ...
                D_t16 out_data;
                in_data = fifo_D_drain_local_in.read();
                int split_idx = (65536*c0 + 512*c1 + 4*c2 + 4096*c5 + 32*c6 + c7) % 4;
                data_split[split_idx] = in_data;
                out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);                if (c7 % 4 == 4 - 1 || c7 == 3) {
                  D[(((16 * c0 + c5) * 128 + (16 * c1 + c6)) * 128 + (16 * c2 + 4 * c7)) / 16] = out_data;
                }
              }
            }
          }
