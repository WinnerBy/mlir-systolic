...
void A_IO_L1_in_intra_trans(int idx, int idy, A_t8 local_A[8][128][16], hls::stream<A_t8> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L1_in_inter_trans(int idx, int idy, A_t8 local_A[8][128][16], hls::stream<A_t8> &fifo_A_in, hls::stream<A_t8> &fifo_A_out, bool inter_trans_en);
void A_IO_L1_in_inter_trans_boundary(int idx, int idy, A_t8 local_A[8][128][16], hls::stream<A_t8> &fifo_A_in, bool inter_trans_en);
...
void B_IO_L2_in_intra_trans(int idx, B_t16 local_B[128][8], hls::stream<float> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L2_in_inter_trans(int idx, B_t16 local_B[128][8], hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_out, bool inter_trans_en);
void B_IO_L2_in_inter_trans_boundary(int idx, B_t16 local_B[128][8], hls::stream<B_t16> &fifo_B_in, bool inter_trans_en);
void C_IO_L2_in_intra_trans(int idx, C_t16 local_C[16][8], hls::stream<C_t8> &fifo_C_local_out, bool intra_trans_en);
void C_IO_L2_in_inter_trans(int idx, C_t16 local_C[16][8], hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
void C_IO_L2_in_inter_trans_boundary(int idx, C_t16 local_C[16][8], hls::stream<C_t16> &fifo_C_in, bool inter_trans_en);
void PE_wrapper(int idx, int idy, hls::stream<A_t8> &fifo_A_in, hls::stream<float> &fifo_B_in, hls::stream<float> &fifo_B_out, hls::stream<C_t8> &fifo_C_in, hls::stream<C_t8> &fifo_C_out, hls::stream<float> &fifo_D_drain_out);
void D_drain_IO_L1_out_intra_trans(int idx, int idy, D_t4 local_D[8][128][4], hls::stream<float> &fifo_D_drain_local_in);
void D_drain_IO_L1_out_inter_trans(int idx, int idy, D_t4 local_D[8][128][4], hls::stream<D_t4> &fifo_D_drain_in, hls::stream<D_t4> &fifo_D_drain_out);
void D_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, D_t4 local_D[8][128][4], hls::stream<D_t4> &fifo_D_drain_out);
          ...
          for (ap_uint<5> c10 = 0; c10 <= 15; c10 += 1) {
            ...
            #pragma HLS PIPELINE II=1
              // simd
              {
                B_t16 in_data;
                B_t1 out_data;
                in_data = local_B[c7][(16 * c6 + c9) / 16];
                for (ap_uint<5> n = 0; n < 16; n++) {
                #pragma HLS UNROLL
                  data_split[n] = in_data(31, 0);
                  in_data = in_data >> 32;
                }
                int split_idx = (16*c6 + c9) % 16;
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<A_t8> &fifo_A_in, hls::stream<float> &fifo_B_in, hls::stream<float> &fifo_B_out, hls::stream<C_t8> &fifo_C_in, hls::stream<C_t8> &fifo_C_out, hls::stream<float> &fifo_D_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t1 local_A[1][1][8];
            ...
            #pragma HLS PIPELINE II=1
              {
                ...
                #pragma HLS UNROLL
                  local_D[c11][16*c6 + c9][c10] = (local_D[c11][16*c6 + c9][c10] + ((local_A[0][0][c12] * local_B[0][0]) * local_C[0][c12]));
                }
                if (c7 == 127 && c8 == 15)
                  fifo_D_drain_out.write(local_D[c11][16*c6 + c9][c10]);
                {
                  C_t8 fifo_data;
      ...
      for (ap_uint<5> c10 = 0; c10 <= 15; c10 += 1) {
        ...
        #pragma HLS PIPELINE II=1
          // simd
          {
            ...
            int split_idx = (c10) % 4;
            out_data = local_D[c11][16*c6 + c9][c10 / 4];
            ...
            out_data = (data_split[3], data_split[2], data_split[1], data_split[0]);            local_D[c11][16*c6 + c9][c10 / 4] = out_data;
          }
        }
      }
    }
...
#pragma HLS DATAFLOW
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_0_11;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_0_12;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_0_13;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_0_14;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_0_15;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_0_16;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_1_11;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_1_12;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_1_13;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_1_14;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_1_15;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_1_16;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_2_11;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_2_12;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_2_13;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_2_14;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_2_15;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_2_16;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_3_11;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_3_12;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_3_13;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_3_14;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_3_15;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_3_16;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_4_11;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_4_12;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_4_13;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_4_14;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_4_15;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_4_16;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_5_11;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_5_12;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_5_13;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_5_14;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_5_15;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_5_16;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_6_11;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_6_12;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_6_13;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_6_14;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_6_15;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_6_16;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_7_11;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_7_12;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_7_13;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_7_14;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_7_15;
  ...
  /* A_IO_L1_in fifo */ hls::stream<A_t8> fifo_A_A_IO_L1_in_7_16;
