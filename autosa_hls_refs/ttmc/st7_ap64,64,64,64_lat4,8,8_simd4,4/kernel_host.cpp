...
//      C[m][k] = 2.5;
  ...
  // computation
  {
    ...
    std::vector<float, aligned_allocator<float>> dev_A(67108864);
    std::vector<float, aligned_allocator<float>> dev_B_unserialized((128) * (128));
    std::vector<float, aligned_allocator<float>> dev_B(524288);
    std::vector<float, aligned_allocator<float>> dev_C_unserialized((128) * (128));
    std::vector<float, aligned_allocator<float>> dev_C(2097152);
