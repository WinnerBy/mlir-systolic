// AutoSA Command:
// /workspaces/mlir-systolic/third_party/AutoSA/autosa /workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/ttmc/kernel.c --config=/workspaces/mlir-systolic/third_party/AutoSA/autosa_config/autosa_config.json --target=autosa_hls_c --output-dir=/workspaces/mlir-systolic/third_party/AutoSA/autosa.tmp/output --host-serialize --simd-info=/workspaces/mlir-systolic/third_party/AutoSA/autosa_tests/large/ttmc/simd_info.json --sa-sizes={kernel[]->space_time[4];kernel[]->array_part[128,128,128,128];kernel[]->latency[8,16,16];kernel[]->simd[8,8]}
...
void A_IO_L2_in_intra_trans(int idx, A_t16 local_A[8][128][8], hls::stream<A_t8> &fifo_A_local_out, bool intra_trans_en);
void A_IO_L2_in_inter_trans(int idx, A_t16 local_A[8][128][8], hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, bool inter_trans_en);
void A_IO_L2_in_inter_trans_boundary(int idx, A_t16 local_A[8][128][8], hls::stream<A_t16> &fifo_A_in, bool inter_trans_en);
void B_IO_L2_in_intra_trans(int idx, B_t16 local_B[128][1], hls::stream<float> &fifo_B_local_out, bool intra_trans_en);
void B_IO_L2_in_inter_trans(int idx, B_t16 local_B[128][1], hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_out, bool inter_trans_en);
void B_IO_L2_in_inter_trans_boundary(int idx, B_t16 local_B[128][1], hls::stream<B_t16> &fifo_B_in, bool inter_trans_en);
void C_IO_L2_in_intra_trans(int idx, C_t16 local_C[128][8], hls::stream<C_t8> &fifo_C_local_out, bool intra_trans_en);
void C_IO_L2_in_inter_trans(int idx, C_t16 local_C[128][8], hls::stream<C_t16> &fifo_C_in, hls::stream<C_t16> &fifo_C_out, bool inter_trans_en);
void C_IO_L2_in_inter_trans_boundary(int idx, C_t16 local_C[128][8], hls::stream<C_t16> &fifo_C_in, bool inter_trans_en);
...
void D_drain_IO_L1_out_intra_trans(int idx, int idy, D_t4 local_D[8][16][32], hls::stream<float> &fifo_D_drain_local_in);
void D_drain_IO_L1_out_inter_trans(int idx, int idy, D_t4 local_D[8][16][32], hls::stream<D_t4> &fifo_D_drain_in, hls::stream<D_t4> &fifo_D_drain_out);
void D_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, D_t4 local_D[8][16][32], hls::stream<D_t4> &fifo_D_drain_out);
          ...
          for (ap_uint<5> c10 = 0; c10 <= 15; c10 += 1) {
            ...
            #pragma HLS PIPELINE II=1
              // simd
              {
                A_t16 in_data;
                A_t8 out_data;
                in_data = local_A[c11][c7][8 * c8 / 16];
