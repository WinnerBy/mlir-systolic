...
struct ArrayAccessPattern {
  ...
  // Access operations (stored as Operation* to avoid incomplete type issues)
...
private:
  ...
  // Note: ArrayRefGroup is defined in SystolicDataflowGeneration.cpp
  // We don't need to extract from it here since we analyze directly from the function
